...
},{"./../images/top-tenpo-4-3.jpg":[["top-tenpo-4-3.a68ef482.jpg","../images/top-tenpo-4-3.jpg"],"../images/top-tenpo-4-3.jpg"],"_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"calendar.js":[function(require,module,exports) {
...
(function (scope) {
  ...
  function _Char_fromCode(code) {
    return _Utils_chr(code < 0 || 0x10FFFF < code ? "\uFFFD" : code <= 0xFFFF ? String.fromCharCode(code) : (code -= 0x10000, String.fromCharCode(Math.floor(code / 0x400) + 0xD800) + String.fromCharCode(code % 0x400 + 0xDC00)));
  }
  ...
  */
  ...
  var author$project$Main$GetToday = function author$project$Main$GetToday(a) {
    return {
      $: 'GetToday',
      a: a
    };
  ...
  var author$project$Main$Loading = {
    $: 'Loading'
  };
  ...
  var justinmimbs$date$Date$RD = function justinmimbs$date$Date$RD(a) {
    return {
      $: 'RD',
      a: a
    };
  ...
  var justinmimbs$date$Date$isLeapYear = function justinmimbs$date$Date$isLeapYear(y) {
  ...
  var justinmimbs$date$Date$daysBeforeYear = function justinmimbs$date$Date$daysBeforeYear(y1) {
    var y = y1 - 1;
  ...
  var justinmimbs$date$Date$isBetweenInt = F3(function (a, b, x) {
  ...
  var justinmimbs$date$Date$numberToMonth = function justinmimbs$date$Date$numberToMonth(mn) {
  ...
  var justinmimbs$date$Date$fromCalendarParts = F3(function (y, mn, d) {
    return A3(justinmimbs$date$Date$isBetweenInt, 1, 12, mn) && A3(justinmimbs$date$Date$isBetweenInt, 1, A2(justinmimbs$date$Date$daysInMonth, y, justinmimbs$date$Date$numberToMonth(mn)), d) ? elm$core$Result$Ok(justinmimbs$date$Date$RD(justinmimbs$date$Date$daysBeforeYear(y) + A2(justinmimbs$date$Date$daysBeforeMonth, y, justinmimbs$date$Date$numberToMonth(mn)) + d)) : elm$core$Result$Err('Invalid calendar date (' + (elm$core$String$fromInt(y) + (', ' + (elm$core$String$fromInt(mn) + (', ' + (elm$core$String$fromInt(d) + ')'))))));
  });
  var justinmimbs$date$Date$fromOrdinalParts = F2(function (y, od) {
    return A3(justinmimbs$date$Date$isBetweenInt, 1, 365, od) || od === 366 && justinmimbs$date$Date$isLeapYear(y) ? elm$core$Result$Ok(justinmimbs$date$Date$RD(justinmimbs$date$Date$daysBeforeYear(y) + od)) : elm$core$Result$Err('Invalid ordinal date (' + (elm$core$String$fromInt(y) + (', ' + (elm$core$String$fromInt(od) + ')'))));
  });

  var justinmimbs$date$Date$weekdayNumber = function justinmimbs$date$Date$weekdayNumber(_n0) {
    var rd = _n0.a;
  ...
  var justinmimbs$date$Date$daysBeforeWeekYear = function justinmimbs$date$Date$daysBeforeWeekYear(y) {
    var jan4 = justinmimbs$date$Date$daysBeforeYear(y) + 4;
    return jan4 - justinmimbs$date$Date$weekdayNumber(justinmimbs$date$Date$RD(jan4));
  };

  var justinmimbs$date$Date$firstOfYear = function justinmimbs$date$Date$firstOfYear(y) {
    return justinmimbs$date$Date$RD(justinmimbs$date$Date$daysBeforeYear(y) + 1);
  };

  var justinmimbs$date$Date$is53WeekYear = function justinmimbs$date$Date$is53WeekYear(y) {
    var wdnJan1 = justinmimbs$date$Date$weekdayNumber(justinmimbs$date$Date$firstOfYear(y));
    return wdnJan1 === 4 || wdnJan1 === 3 && justinmimbs$date$Date$isLeapYear(y);
  };

  var justinmimbs$date$Date$fromWeekParts = F3(function (wy, wn, wdn) {
    return A3(justinmimbs$date$Date$isBetweenInt, 1, 7, wdn) && (A3(justinmimbs$date$Date$isBetweenInt, 1, 52, wn) || wn === 53 && justinmimbs$date$Date$is53WeekYear(wy)) ? elm$core$Result$Ok(justinmimbs$date$Date$RD(justinmimbs$date$Date$daysBeforeWeekYear(wy) + (wn - 1) * 7 + wdn)) : elm$core$Result$Err('Invalid week date (' + (elm$core$String$fromInt(wy) + (', ' + (elm$core$String$fromInt(wn) + (', ' + (elm$core$String$fromInt(wdn) + ')'))))));
  });

  var justinmimbs$date$Date$fromYearAndDay = function justinmimbs$date$Date$fromYearAndDay(_n0) {
    var y = _n0.a;
    var doy = _n0.b;
  ...
  var elm$parser$Parser$Advanced$end = function elm$parser$Parser$Advanced$end(x) {
    return elm$parser$Parser$Advanced$Parser(function (s) {
  ...
  var elm$parser$Parser$Advanced$backtrackable = function elm$parser$Parser$Advanced$backtrackable(_n0) {
    var parse = _n0.a;
    return elm$parser$Parser$Advanced$Parser(function (s0) {
      var _n1 = parse(s0);
  ...
  var elm$parser$Parser$Advanced$commit = function elm$parser$Parser$Advanced$commit(a) {
    return elm$parser$Parser$Advanced$Parser(function (s) {
  ...
  var elm$parser$Parser$Advanced$token = function elm$parser$Parser$Advanced$token(_n0) {
    var str = _n0.a;
    var expecting = _n0.b;
  ...
  var justinmimbs$date$Date$MonthAndDay = F2(function (a, b) {
    return {
      $: 'MonthAndDay',
      a: a,
      b: b
  ...
  var justinmimbs$date$Date$OrdinalDay = function justinmimbs$date$Date$OrdinalDay(a) {
    return {
      $: 'OrdinalDay',
      a: a
    };
  ...
  var justinmimbs$date$Date$WeekAndWeekday = F2(function (a, b) {
    return {
      $: 'WeekAndWeekday',
      a: a,
      b: b
  ...
  var justinmimbs$date$Date$int1 = A2(elm$parser$Parser$mapChompedString, F2(function (str, _n0) {
    return A2(elm$core$Maybe$withDefault, 0, elm$core$String$toInt(str));
  }), elm$parser$Parser$chompIf(elm$core$Char$isDigit));
  var justinmimbs$date$Date$int2 = A2(elm$parser$Parser$mapChompedString, F2(function (str, _n0) {
    return A2(elm$core$Maybe$withDefault, 0, elm$core$String$toInt(str));
  }), A2(elm$parser$Parser$ignorer, A2(elm$parser$Parser$ignorer, elm$parser$Parser$succeed(_Utils_Tuple0), elm$parser$Parser$chompIf(elm$core$Char$isDigit)), elm$parser$Parser$chompIf(elm$core$Char$isDigit)));
  var justinmimbs$date$Date$int3 = A2(elm$parser$Parser$mapChompedString, F2(function (str, _n0) {
    return A2(elm$core$Maybe$withDefault, 0, elm$core$String$toInt(str));
  }), A2(elm$parser$Parser$ignorer, A2(elm$parser$Parser$ignorer, A2(elm$parser$Parser$ignorer, elm$parser$Parser$succeed(_Utils_Tuple0), elm$parser$Parser$chompIf(elm$core$Char$isDigit)), elm$parser$Parser$chompIf(elm$core$Char$isDigit)), elm$parser$Parser$chompIf(elm$core$Char$isDigit)));
  var justinmimbs$date$Date$dayOfYear = elm$parser$Parser$oneOf(_List_fromArray([A2(elm$parser$Parser$keeper, A2(elm$parser$Parser$ignorer, elm$parser$Parser$succeed(elm$core$Basics$identity), elm$parser$Parser$token('-')), elm$parser$Parser$oneOf(_List_fromArray([elm$parser$Parser$backtrackable(A2(elm$parser$Parser$andThen, elm$parser$Parser$commit, A2(elm$parser$Parser$map, justinmimbs$date$Date$OrdinalDay, justinmimbs$date$Date$int3))), A2(elm$parser$Parser$keeper, A2(elm$parser$Parser$keeper, elm$parser$Parser$succeed(justinmimbs$date$Date$MonthAndDay), justinmimbs$date$Date$int2), elm$parser$Parser$oneOf(_List_fromArray([A2(elm$parser$Parser$keeper, A2(elm$parser$Parser$ignorer, elm$parser$Parser$succeed(elm$core$Basics$identity), elm$parser$Parser$token('-')), justinmimbs$date$Date$int2), elm$parser$Parser$succeed(1)]))), A2(elm$parser$Parser$keeper, A2(elm$parser$Parser$keeper, A2(elm$parser$Parser$ignorer, elm$parser$Parser$succeed(justinmimbs$date$Date$WeekAndWeekday), elm$parser$Parser$token('W')), justinmimbs$date$Date$int2), elm$parser$Parser$oneOf(_List_fromArray([A2(elm$parser$Parser$keeper, A2(elm$parser$Parser$ignorer, elm$parser$Parser$succeed(elm$core$Basics$identity), elm$parser$Parser$token('-')), justinmimbs$date$Date$int1), elm$parser$Parser$succeed(1)])))]))), elm$parser$Parser$backtrackable(A2(elm$parser$Parser$andThen, elm$parser$Parser$commit, A2(elm$parser$Parser$keeper, A2(elm$parser$Parser$keeper, elm$parser$Parser$succeed(justinmimbs$date$Date$MonthAndDay), justinmimbs$date$Date$int2), elm$parser$Parser$oneOf(_List_fromArray([justinmimbs$date$Date$int2, elm$parser$Parser$succeed(1)]))))), A2(elm$parser$Parser$map, justinmimbs$date$Date$OrdinalDay, justinmimbs$date$Date$int3), A2(elm$parser$Parser$keeper, A2(elm$parser$Parser$keeper, A2(elm$parser$Parser$ignorer, elm$parser$Parser$succeed(justinmimbs$date$Date$WeekAndWeekday), elm$parser$Parser$token('W')), justinmimbs$date$Date$int2), elm$parser$Parser$oneOf(_List_fromArray([justinmimbs$date$Date$int1, elm$parser$Parser$succeed(1)]))), elm$parser$Parser$succeed(justinmimbs$date$Date$OrdinalDay(1))]));
  var justinmimbs$date$Date$int4 = A2(elm$parser$Parser$mapChompedString, F2(function (str, _n0) {
    return A2(elm$core$Maybe$withDefault, 0, elm$core$String$toInt(str));
  }), A2(elm$parser$Parser$ignorer, A2(elm$parser$Parser$ignorer, A2(elm$parser$Parser$ignorer, A2(elm$parser$Parser$ignorer, A2(elm$parser$Parser$ignorer, elm$parser$Parser$succeed(_Utils_Tuple0), elm$parser$Parser$oneOf(_List_fromArray([elm$parser$Parser$chompIf(function (c) {
    return _Utils_eq(c, _Utils_chr('-'));
  }), elm$parser$Parser$succeed(_Utils_Tuple0)]))), elm$parser$Parser$chompIf(elm$core$Char$isDigit)), elm$parser$Parser$chompIf(elm$core$Char$isDigit)), elm$parser$Parser$chompIf(elm$core$Char$isDigit)), elm$parser$Parser$chompIf(elm$core$Char$isDigit)));
  var justinmimbs$date$Date$yearAndDay = A2(elm$parser$Parser$keeper, A2(elm$parser$Parser$keeper, elm$parser$Parser$succeed(elm$core$Tuple$pair), justinmimbs$date$Date$int4), A2(elm$parser$Parser$ignorer, justinmimbs$date$Date$dayOfYear, elm$parser$Parser$end));
  var justinmimbs$date$Date$fromIsoString = A2(elm$core$Basics$composeR, elm$parser$Parser$run(justinmimbs$date$Date$yearAndDay), A2(elm$core$Basics$composeR, elm$core$Result$mapError(function (_n0) {
    return 'String is not in IS0 8601 date format';
  }), elm$core$Result$andThen(justinmimbs$date$Date$fromYearAndDay)));

  var author$project$HolidayParser$stringToDate = function author$project$HolidayParser$stringToDate(string) {
    var _n0 = justinmimbs$date$Date$fromIsoString(string);

    if (_n0.$ === 'Ok') {
      var date = _n0.a;
      return elm$parser$Parser$succeed(date);
    } else {
      return elm$parser$Parser$problem('Invalid ISO Date Format');
    }
  };
  ...
  var author$project$HolidayParser$dateParser = A2(elm$parser$Parser$andThen, author$project$HolidayParser$stringToDate, elm$parser$Parser$getChompedString(elm$parser$Parser$chompWhile(function (c) {
    return elm$core$Char$isDigit(c) || _Utils_eq(c, _Utils_chr('-'));
  })));
  ...
  var author$project$HolidayParser$event = elm$parser$Parser$getChompedString(A2(elm$parser$Parser$ignorer, elm$parser$Parser$succeed(_Utils_Tuple0), elm$parser$Parser$chompUntilEndOr(']')));
  ...
  var elm$parser$Parser$ExpectingSymbol = function elm$parser$Parser$ExpectingSymbol(a) {
    return {
      $: 'ExpectingSymbol',
      a: a
    };
  ...
  var elm$parser$Parser$symbol = function elm$parser$Parser$symbol(str) {
    return elm$parser$Parser$Advanced$symbol(A2(elm$parser$Parser$Advanced$Token, str, elm$parser$Parser$ExpectingSymbol(str)));
  };

  var author$project$HolidayParser$holiday = A2(elm$parser$Parser$keeper, A2(elm$parser$Parser$keeper, A2(elm$parser$Parser$ignorer, elm$parser$Parser$succeed(F2(function (a, b) {
    return _Utils_Tuple2(a, b);
  })), elm$parser$Parser$symbol('[')), A2(elm$parser$Parser$ignorer, author$project$HolidayParser$dateParser, elm$parser$Parser$spaces)), A2(elm$parser$Parser$ignorer, author$project$HolidayParser$event, elm$parser$Parser$symbol(']')));
  ...
  var author$project$HolidayParser$listHelp = function author$project$HolidayParser$listHelp(revHoliday) {
    return elm$parser$Parser$oneOf(_List_fromArray([A2(elm$parser$Parser$keeper, elm$parser$Parser$succeed(function (h) {
      return elm$parser$Parser$Loop(A2(elm$core$List$cons, h, revHoliday));
    }), A2(elm$parser$Parser$ignorer, author$project$HolidayParser$holiday, elm$parser$Parser$spaces)), A2(elm$parser$Parser$map, function (_n0) {
      return elm$parser$Parser$Done(elm$core$List$reverse(revHoliday));
  ...
  var author$project$HolidayParser$list = A2(elm$parser$Parser$loop, _List_Nil, author$project$HolidayParser$listHelp);
  ...
  var author$project$HolidayParser$parser = function author$project$HolidayParser$parser(string) {
    return A2(elm$parser$Parser$run, author$project$HolidayParser$list, A2(elm$core$String$dropRight, 1, A2(elm$core$String$dropLeft, 1, string)));
  };
  ...
  var author$project$Main$listOfHolidayParser = function author$project$Main$listOfHolidayParser(string) {
    var _n0 = author$project$HolidayParser$parser(string);

    if (_n0.$ === 'Ok') {
      var result = _n0.a;
      return elm$json$Json$Decode$succeed(result);
    } else {
      return elm$json$Json$Decode$fail('Failed to decode list of holiday...');
    }
  };
  ...
  var author$project$Main$flagsDecoder = A2(elm$json$Json$Decode$andThen, function (string) {
    return author$project$Main$listOfHolidayParser(string);
  }, A2(elm$json$Json$Decode$field, 'holiday', elm$json$Json$Decode$string));
  var elm$time$Time$flooredDiv = F2(function (numerator, denominator) {
    return elm$core$Basics$floor(numerator / denominator);
  });

  var elm$time$Time$posixToMillis = function elm$time$Time$posixToMillis(_n0) {
    var millis = _n0.a;
    return millis;
  };
  ...
  var elm$time$Time$toCivil = function elm$time$Time$toCivil(minutes) {
  ...
  var elm$time$Time$toMonth = F2(function (zone, time) {
    var _n0 = elm$time$Time$toCivil(A2(elm$time$Time$toAdjustedMinutes, zone, time)).month;
  ...
  var author$project$Main$zoneTimeToDate = F2(function (zone, now) {
    return A3(justinmimbs$date$Date$fromCalendarDate, A2(elm$time$Time$toYear, zone, now), A2(elm$time$Time$toMonth, zone, now), A2(elm$time$Time$toDay, zone, now));
  });
  ...
  var author$project$Main$whatDayToday = A3(elm$core$Task$map2, author$project$Main$zoneTimeToDate, elm$time$Time$here, elm$time$Time$now);
  ...
  var author$project$Main$init = function author$project$Main$init(flags) {
    ...
    if (_n0.$ === 'Ok') {
      ...
      return _Utils_Tuple2({
        holiday: holiday,
        today: author$project$Main$Loading
      }, A2(elm$core$Task$perform, author$project$Main$GetToday, author$project$Main$whatDayToday));
    } else {
      return _Utils_Tuple2({
        holiday: _List_Nil,
        today: author$project$Main$Error
      }, elm$core$Platform$Cmd$none);
    }
  };

  var author$project$Main$Today = function author$project$Main$Today(a) {
    return {
      $: 'Today',
      a: a
    };
  ...
  var author$project$Main$update = F2(function (msg, model) {
    ...
    return _Utils_Tuple2(_Utils_update(model, {
      today: author$project$Main$Today(date)
    }), elm$core$Platform$Cmd$none);
  });

  var author$project$Calendar$getMonth = function author$project$Calendar$getMonth(_n0) {
    var month = _n0.a.month;
    return month;
  };

  var author$project$Calendar$getYear = function author$project$Calendar$getYear(_n0) {
    var year = _n0.a.year;
    return year;
  };

  var author$project$Calendar$State = function author$project$Calendar$State(a) {
    return {
      $: 'State',
      a: a
    };
  ...
  var justinmimbs$date$Date$monthToNumber = function justinmimbs$date$Date$monthToNumber(m) {
    switch (m.$) {
      case 'Jan':
        return 1;
  ...
  var justinmimbs$date$Date$year = function justinmimbs$date$Date$year(_n0) {
    var rd = _n0.a;
  ...
  var justinmimbs$date$Date$toOrdinalDate = function justinmimbs$date$Date$toOrdinalDate(_n0) {
    var rd = _n0.a;
  ...
  var justinmimbs$date$Date$toCalendarDate = function justinmimbs$date$Date$toCalendarDate(_n0) {
    var rd = _n0.a;
  ...
  var author$project$Calendar$initWithDate = function author$project$Calendar$initWithDate(date) {
  ...
  var author$project$Calendar$header = function author$project$Calendar$header(_n0) {
    var attributes = _n0.attributes;
    var children = _n0.children;
    return A2(elm$html$Html$thead, attributes, _List_fromArray([A2(elm$html$Html$tr, _List_Nil, children)]));
  };
  ...
  var author$project$Calendar$split = F2(function (n, listOfDate) {
    var _n0 = A2(elm$core$List$take, n, listOfDate);

    if (!_n0.b) {
      return _List_Nil;
    } else {
      var listHead = _n0;
      return A2(elm$core$List$cons, listHead, A2(author$project$Calendar$split, n, A2(elm$core$List$drop, n, listOfDate)));
    }
  });
  var author$project$Calendar$tableCell = F2(function (cellAttrs, date) {
    return cellAttrs(date);
  });
  var author$project$Calendar$tableRow = F3(function (cellAttrs, state, listOfDate) {
    return A2(elm$html$Html$tr, _List_Nil, A2(elm$core$List$map, author$project$Calendar$tableCell(cellAttrs), listOfDate));
  });
  ...
  var justinmimbs$date$Date$add = F3(function (unit, n, _n0) {
    var rd = _n0.a;
  ...
  var justinmimbs$date$Date$weekdayToNumber = function justinmimbs$date$Date$weekdayToNumber(wd) {
    switch (wd.$) {
      case 'Mon':
        return 1;
  ...
  var justinmimbs$date$Date$monthToQuarter = function justinmimbs$date$Date$monthToQuarter(m) {
    return (justinmimbs$date$Date$monthToNumber(m) + 2) / 3 | 0;
  };

  var justinmimbs$date$Date$quarter = A2(elm$core$Basics$composeR, justinmimbs$date$Date$month, justinmimbs$date$Date$monthToQuarter);

  var justinmimbs$date$Date$quarterToMonth = function justinmimbs$date$Date$quarterToMonth(q) {
  ...
  var justinmimbs$date$Date$Weeks = {
    $: 'Weeks'
  };
  var justinmimbs$date$Date$Years = {
    $: 'Years'
  };

  var justinmimbs$date$Date$intervalToUnits = function justinmimbs$date$Date$intervalToUnits(interval) {
    switch (interval.$) {
      case 'Year':
  ...
  var justinmimbs$date$Date$ceiling = F2(function (interval, date) {
  ...
  var justinmimbs$date$Date$rangeHelp = F5(function (unit, step, until, revList, current) {
    rangeHelp: while (true) {
      if (_Utils_cmp(current, until) < 0) {
        var _n0 = A3(justinmimbs$date$Date$add, unit, step, justinmimbs$date$Date$RD(current));

        var next = _n0.a;
        var $temp$unit = unit,
            $temp$step = step,
            $temp$until = until,
            $temp$revList = A2(elm$core$List$cons, justinmimbs$date$Date$RD(current), revList),
            $temp$current = next;
        unit = $temp$unit;
        step = $temp$step;
        until = $temp$until;
  ...
  var justinmimbs$date$Date$range = F4(function (interval, step, _n0, _n1) {
    var start = _n0.a;
    var until = _n1.a;

    var _n2 = justinmimbs$date$Date$intervalToUnits(interval);

    var n = _n2.a;
    var unit = _n2.b;

    var _n3 = A2(justinmimbs$date$Date$ceiling, interval, justinmimbs$date$Date$RD(start));

    var first = _n3.a;
    return _Utils_cmp(first, until) < 0 ? A5(justinmimbs$date$Date$rangeHelp, unit, A2(elm$core$Basics$max, 1, step) * n, until, _List_Nil, first) : _List_Nil;
  });
  var author$project$Calendar$view = F2(function (_n0, state) {
    var cellAttrs = _n0.a.cellAttrs;
    var customizations = _n0.a.customizations;
    var year = state.a.year;
    var month = state.a.month;
    var firstDay = A3(justinmimbs$date$Date$fromCalendarDate, year, month, 1);
    var start = A2(justinmimbs$date$Date$floor, justinmimbs$date$Date$Sunday, firstDay);
    var end = A3(justinmimbs$date$Date$add, justinmimbs$date$Date$Days, 42, start);
    var listOfDate = A2(elm$core$List$map, A2(author$project$Calendar$tableRow, cellAttrs, state), A2(author$project$Calendar$split, 7, A4(justinmimbs$date$Date$range, justinmimbs$date$Date$Day, 1, start, end)));
    return A2(elm$html$Html$table, customizations.tableAttrs, _List_fromArray([author$project$Calendar$header(customizations.tableHeader(_List_fromArray([elm$time$Time$Sun, elm$time$Time$Mon, elm$time$Time$Tue, elm$time$Time$Wed, elm$time$Time$Thu, elm$time$Time$Fri, elm$time$Time$Sat]))), A2(elm$html$Html$tbody, customizations.tbodyAttrs, listOfDate)]));
  });

  var author$project$Calendar$Config = function author$project$Calendar$Config(a) {
    return {
      $: 'Config',
      a: a
    };
  ...
  var author$project$Calendar$configWithCusgtomizations = function author$project$Calendar$configWithCusgtomizations(_n0) {
    var cellAttrs = _n0.cellAttrs;
  ...
  var author$project$Calendar$inMonth = F2(function (_n0, date) {
    var month = _n0.a.month;
    return _Utils_eq(justinmimbs$date$Date$month(date), month);
  });
  ...
  var justinmimbs$date$Date$day = A2(elm$core$Basics$composeR, justinmimbs$date$Date$toCalendarDate, function ($) {
    return $.day;
  });
  var justinmimbs$date$Date$isBetween = F3(function (_n0, _n1, _n2) {
    var a = _n0.a;
    var b = _n1.a;
    var x = _n2.a;
  ...
  var justinmimbs$date$Date$numberToWeekday = function justinmimbs$date$Date$numberToWeekday(wdn) {
  ...
  var author$project$Main$cellAttrs = F3(function (_n0, state, date) {
    var national = _n0.national;
    var special = _n0.special;
    var today = _n0.today;

    var base = _List_fromArray([elm$html$Html$Attributes$class('text-center p-1 border-grey border border-solid w-8 h-8')]);

    if (A2(author$project$Calendar$inMonth, state, date)) {
      var temporary = A2(elm$core$List$any, elm$core$Basics$eq(true), A2(elm$core$List$map, function (_n4) {
        var min = _n4.a;
        var max = _n4.b;
        return A3(justinmimbs$date$Date$isBetween, min, max, date);
      }, special)) ? _List_fromArray([elm$html$Html$Attributes$class('bg-orange')]) : _List_Nil;

      var closed = _List_fromArray([elm$html$Html$Attributes$class('bg-green text-white')]);

      var additional = function () {
        if (_Utils_eq(justinmimbs$date$Date$weekday(date), elm$time$Time$Wed)) {
          return closed;
        } else {
          if (_Utils_eq(justinmimbs$date$Date$weekday(date), elm$time$Time$Tue)) {
            var sat = ((justinmimbs$date$Date$day(date) - 1) / 7 | 0) + 1;
            return sat === 1 || sat === 3 ? closed : _List_Nil;
          } else {
            if (_Utils_eq(justinmimbs$date$Date$weekday(date), elm$time$Time$Sun)) {
              return _List_fromArray([elm$html$Html$Attributes$class('text-red-dark')]);
            } else {
              if (_Utils_eq(justinmimbs$date$Date$weekday(date), elm$time$Time$Sat)) {
                return _List_fromArray([elm$html$Html$Attributes$class('text-blue-dark')]);
              } else {
                var _n1 = elm$core$List$head(A2(elm$core$List$filter, function (_n2) {
                  var a = _n2.a;
                  var b = _n2.b;
                  return _Utils_eq(a, date);
                }, national));

                if (_n1.$ === 'Just') {
                  var _n3 = _n1.a;
                  var event = _n3.b;
                  return _List_fromArray([elm$html$Html$Attributes$class('text-red-dark'), elm$html$Html$Attributes$title(event)]);
                } else {
                  return _List_fromArray([elm$html$Html$Attributes$class('text-black')]);
                }
              }
            }
          }
      ...
      var tdWithToday = F2(function (a, b) {
        return _Utils_eq(a, b) ? A2(elm$html$Html$td, elm$core$List$concat(_List_fromArray([base, temporary, additional, _List_fromArray([elm$html$Html$Attributes$class('p-0'), elm$html$Html$Attributes$title('今日')])])), _List_fromArray([A2(elm$html$Html$span, _List_fromArray([elm$html$Html$Attributes$class('border-2 rounded-full bg-red border-red text-white')]), _List_fromArray([elm$html$Html$text(elm$core$String$fromInt(justinmimbs$date$Date$day(date)))]))])) : A2(elm$html$Html$td, elm$core$List$concat(_List_fromArray([base, temporary, additional])), _List_fromArray([elm$html$Html$text(elm$core$String$fromInt(justinmimbs$date$Date$day(date)))]));
      });
      return A2(tdWithToday, date, today);
    } else {
      return A2(elm$html$Html$td, base, _List_Nil);
    }
  });

  var author$project$Main$weekdayToKanjiShort = function author$project$Main$weekdayToKanjiShort(weekday) {
    var cell = F2(function (classNames, weekdayString) {
      return A2(elm$html$Html$td, _List_fromArray([elm$html$Html$Attributes$class('text-center p-1 border-grey border border-solid ' + classNames)]), _List_fromArray([elm$html$Html$text(weekdayString)]));
    });

    switch (weekday.$) {
      case 'Sun':
        return A2(cell, 'text-red-dark', '日');
      ...
      default:
        return A2(cell, 'text-blue-dark', '土');
    }
  };

  var author$project$Main$myThead = function author$project$Main$myThead(weeekdays) {
    return {
      attributes: _List_Nil,
      children: A2(elm$core$List$map, author$project$Main$weekdayToKanjiShort, weeekdays)
    };
  };

  var author$project$Main$customizations = {
    tableAttrs: _List_fromArray([elm$html$Html$Attributes$class('mx-auto border-collapse bg-white')]),
    tableHeader: author$project$Main$myThead,
    tbodyAttrs: _List_Nil
  };
  var author$project$Main$calendarConfig = F3(function (calendar, holiday, today) {
    return author$project$Calendar$configWithCusgtomizations({
      cellAttrs: A2(author$project$Main$cellAttrs, {
        national: holiday,
        special: _List_Nil,
        today: today
      }, calendar),
      customizations: author$project$Main$customizations
    });
  });

  var elm$core$String$concat = function elm$core$String$concat(strings) {
  ...
  var author$project$Main$view = function author$project$Main$view(model) {
    ...
    switch (_n0.$) {
      case 'Today':
        var today = _n0.a;
        return A2(elm$html$Html$div, _List_Nil, A2(elm$core$List$map, function (calendar) {
          return A2(elm$html$Html$div, _List_fromArray([elm$html$Html$Attributes$class('text-center mb-2 mx-auto p-4')]), _List_fromArray([A2(elm$html$Html$p, _List_fromArray([elm$html$Html$Attributes$class('mb-2')]), _List_fromArray([elm$html$Html$text(elm$core$String$concat(_List_fromArray([elm$core$String$fromInt(author$project$Calendar$getYear(calendar)), '年', elm$core$String$fromInt(justinmimbs$date$Date$monthToNumber(author$project$Calendar$getMonth(calendar))), '月'])))])), A2(author$project$Calendar$view, A3(author$project$Main$calendarConfig, calendar, model.holiday, today), calendar)]));
        }, A2(elm$core$List$map, function (i) {
          return author$project$Calendar$initWithDate(A3(justinmimbs$date$Date$add, justinmimbs$date$Date$Months, i - 1, today));
        }, A2(elm$core$List$range, 1, 2))));

      case 'Loading':
        return A2(elm$html$Html$div, _List_Nil, _List_fromArray([elm$html$Html$text('準備中')]));

      default:
        return A2(elm$html$Html$div, _List_Nil, _List_fromArray([elm$html$Html$text('エラー')]));
    }
  };
  ...
  var author$project$Main$main = elm$browser$Browser$element({
    ...
    subscriptions: function subscriptions(_n0) {
...
if (node) {
  var fakeUTC = Date.now() - -9 * 60 * 60000;
...
},{"../css/style.scss":"../css/style.scss","./calendar.js":"calendar.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
