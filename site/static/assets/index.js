...
},{}],"../elm-calendar/src/CompanyHoliday.elm":[function(require,module,exports) {
(function(scope){
'use strict';
...
var author$project$Main$GetToday = function (a) {
	return {$: 'GetToday', a: a};
};
var author$project$Main$Loading = {$: 'Loading'};
var author$project$Main$Holiday = F2(
	function (date, label) {
...
var author$project$Main$fieldHelper = function (_n0) {
	var dateString = _n0.a;
	var label = _n0.b;
	var _n1 = justinmimbs$date$Date$fromIsoString(dateString);
	if (_n1.$ === 'Ok') {
		var date = _n1.a;
		return elm$core$Maybe$Just(
			A2(author$project$Main$Holiday, date, label));
	} else {
		return elm$core$Maybe$Nothing;
	}
};
...
var author$project$Main$fieldDecoder = A2(
	elm$json$Json$Decode$map,
	elm$core$List$filterMap(author$project$Main$fieldHelper),
	A2(
		elm$json$Json$Decode$map,
...
var author$project$Main$flagsDecoder = A3(
	...
	elm$core$Tuple$pair,
	A2(elm$json$Json$Decode$field, 'holiday', author$project$Main$fieldDecoder),
	A2(elm$json$Json$Decode$field, 'special', author$project$Main$fieldDecoder));
...
var author$project$Main$zoneTimeToDate = F2(
	function (zone, now) {
		return A3(
			justinmimbs$date$Date$fromCalendarDate,
			A2(elm$time$Time$toYear, zone, now),
			A2(elm$time$Time$toMonth, zone, now),
			A2(elm$time$Time$toDay, zone, now));
	});
...
var author$project$Main$init = function (flags) {
	...
	if (_n0.$ === 'Ok') {
		...
		return _Utils_Tuple2(
			{holiday: holiday, special: special, today: author$project$Main$Loading},
			A2(elm$core$Task$perform, author$project$Main$GetToday, author$project$Main$whatDayToday));
	} else {
		return _Utils_Tuple2(
			{holiday: _List_Nil, special: _List_Nil, today: author$project$Main$Error},
...
var author$project$Calendar$getMonth = function (_n0) {
	var month = _n0.a.month;
	return month;
};
var author$project$Calendar$getYear = function (_n0) {
	var year = _n0.a.year;
	return year;
};
...
var author$project$Calendar$initWithDate = function (date) {
...
var author$project$Calendar$header = function (_n0) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A2(elm$html$Html$tr, _List_Nil, children)
			]));
};
...
var author$project$Calendar$split = F2(
	function (n, listOfDate) {
		...
		if (!_n0.b) {
			...
			return A2(
				...
				listHead,
				A2(
					author$project$Calendar$split,
					n,
					A2(elm$core$List$drop, n, listOfDate)));
		}
	});
var author$project$Calendar$tableCell = F2(
	function (cellAttrs, date) {
		return cellAttrs(date);
	});
var author$project$Calendar$tableRow = F3(
	function (cellAttrs, state, listOfDate) {
		return A2(
			elm$html$Html$tr,
			_List_Nil,
			A2(
				elm$core$List$map,
				author$project$Calendar$tableCell(cellAttrs),
				listOfDate));
	});
...
var justinmimbs$date$Date$range = F4(
	function (interval, step, _n0, _n1) {
		var start = _n0.a;
		var until = _n1.a;
...
var author$project$Calendar$view = F2(
	function (_n0, state) {
		...
		var listOfDate = A2(
			elm$core$List$map,
			A2(author$project$Calendar$tableRow, cellAttrs, state),
			A2(
				author$project$Calendar$split,
				7,
		...
		return A2(
			...
			_List_fromArray(
				[
					author$project$Calendar$header(
					customizations.tableHeader(
						_List_fromArray(
							[elm$time$Time$Sun, elm$time$Time$Mon, elm$time$Time$Tue, elm$time$Time$Wed, elm$time$Time$Thu, elm$time$Time$Fri, elm$time$Time$Sat]))),
					A2(elm$html$Html$tbody, customizations.tbodyAttrs, listOfDate)
				]));
	});
var author$project$Calendar$Config = function (a) {
	return {$: 'Config', a: a};
};
var author$project$Calendar$configWithCusgtomizations = function (_n0) {
	var cellAttrs = _n0.cellAttrs;
	var customizations = _n0.customizations;
	return author$project$Calendar$Config(
		{cellAttrs: cellAttrs, customizations: customizations});
};
var author$project$Calendar$inMonth = F2(
	function (_n0, date) {
		var month = _n0.a.month;
		return _Utils_eq(
			justinmimbs$date$Date$month(date),
...
var author$project$Main$bgClosed = 'bg-green';
var author$project$Main$bgSpecial = 'bg-orange';
var author$project$Main$textClosed = 'text-white';
var author$project$Main$textHoliday = 'text-red-dark';
var author$project$Main$textSaturday = 'text-blue-dark';
var author$project$Main$textWeekday = 'text-black';
...
var author$project$Main$cellAttrs = F3(
	function (_n0, state, date) {
		var national = _n0.national;
		var special = _n0.special;
		var today = _n0.today;
		var base = _List_fromArray(
			[
				elm$html$Html$Attributes$class('text-center p-1 border-grey border border-solid w-8 h-8')
			]);
		if (A2(author$project$Calendar$inMonth, state, date)) {
			var textColor = function () {
				...
				if (_n2.$ === 'Just') {
					...
					return _List_fromArray(
						[
							elm$html$Html$Attributes$class(author$project$Main$textHoliday),
							elm$html$Html$Attributes$title(d.label)
						]);
				} else {
					return _Utils_eq(
						justinmimbs$date$Date$weekday(date),
						elm$time$Time$Sun) ? _List_fromArray(
						[
							elm$html$Html$Attributes$class(author$project$Main$textHoliday)
						]) : (_Utils_eq(
						justinmimbs$date$Date$weekday(date),
						elm$time$Time$Sat) ? _List_fromArray(
						[
							elm$html$Html$Attributes$class(author$project$Main$textSaturday)
						]) : _List_fromArray(
						[
							elm$html$Html$Attributes$class(author$project$Main$textWeekday)
						]));
				}
			}();
					...
					return _List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[author$project$Main$bgSpecial, 'font-bold']))),
							elm$html$Html$Attributes$title(s.label)
						]);
				} else {
					if (_Utils_eq(
						justinmimbs$date$Date$weekday(date),
						...
						return _List_fromArray(
							[
								...
								A2(
									...
									' ',
									_List_fromArray(
										[author$project$Main$bgClosed, author$project$Main$textClosed, 'font-bold']))),
								elm$html$Html$Attributes$title('定休日')
							]);
					} else {
						if (_Utils_eq(
							justinmimbs$date$Date$weekday(date),
							...
							return ((sat === 1) || (sat === 3)) ? _List_fromArray(
								[
									elm$html$Html$Attributes$class(
									A2(
										elm$core$String$join,
							...
							_List_fromArray(
								[
									...
									[
										...
										elm$html$Html$Attributes$title('今日')
									])
								])),
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('border-2 rounded-full bg-red border-red text-white')
									]),
								_List_fromArray(
									[
										elm$html$Html$text(
...
var author$project$Main$weekdayToKanjiShort = function (weekday) {
	var cell = F2(
		function (classNames, weekdayString) {
			return A2(
				elm$html$Html$td,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('text-center p-1 border-grey border border-solid ' + classNames)
					]),
				_List_fromArray(
					[
						elm$html$Html$text(weekdayString)
					]));
		});
	switch (weekday.$) {
		case 'Sun':
			return A2(cell, author$project$Main$textHoliday, '日');
		case 'Mon':
			return A2(cell, '', '月');
		case 'Tue':
			return A2(cell, '', '火');
		...
		case 'Fri':
			return A2(cell, '', '金');
		default:
			return A2(cell, author$project$Main$textSaturday, '土');
	}
};
var author$project$Main$myThead = function (weeekdays) {
	return {
...
var author$project$Main$customizations = {
	tableAttrs: _List_fromArray(
		[
			elm$html$Html$Attributes$class('mx-auto border-collapse bg-white')
		]),
	tableHeader: author$project$Main$myThead,
	tbodyAttrs: _List_Nil
};
var author$project$Main$calendarConfig = F4(
	function (calendar, holiday, special, today) {
		return author$project$Calendar$configWithCusgtomizations(
			{
				cellAttrs: A2(
					author$project$Main$cellAttrs,
					{national: holiday, special: special, today: today},
					calendar),
	...
	switch (_n0.$) {
				...
				A2(
					...
					function (calendar) {
						return A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('text-center mb-2 mx-auto p-4')
								]),
							_List_fromArray(
								[
									A2(
										...
										[
											...
											elm$core$String$concat(
												_List_fromArray(
													[
														elm$core$String$fromInt(
														author$project$Calendar$getYear(calendar)),
														'年',
														elm$core$String$fromInt(
														justinmimbs$date$Date$monthToNumber(
															author$project$Calendar$getMonth(calendar))),
														'月'
													])))
										])),
									A2(
									author$project$Calendar$view,
									A4(author$project$Main$calendarConfig, calendar, model.holiday, model.special, today),
									calendar)
								]));
					},
					A2(
						elm$core$List$map,
						function (i) {
							return author$project$Calendar$initWithDate(
								A3(justinmimbs$date$Date$add, justinmimbs$date$Date$Months, i - 1, today));
						},
		...
		case 'Loading':
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text('営業カレンダーを準備中')
					]));
		default:
			return A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						elm$html$Html$text('営業カレンダーの読込みに失敗')
					]));
	}
};
...
_Platform_export({'Main':{'init':author$project$Main$main(elm$json$Json$Decode$value)({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Date.RataDie":{"args":[],"type":"Basics.Int"}},"unions":{"Main.Msg":{"args":[],"tags":{"GetToday":["Date.Date"]}},"Date.Date":{"args":[],"tags":{"RD":["Date.RataDie"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});
...
},{}],"../elm-contact-form/src/Main.elm":[function(require,module,exports) {
(function(scope){
'use strict';
...
var author$project$Contact$Editting = {$: 'Editting'};
var elm$core$Basics$False = {$: 'False'};
var elm$core$Basics$EQ = {$: 'EQ'};
var elm$core$Basics$LT = {$: 'LT'};
var elm$core$Elm$JsArray$foldr = _JsArray_foldr;
...
var author$project$Contact$init = {agreement: false, content: '', email: '', images: _List_Nil, kana: '', name: '', tel: ''};
var elm$core$Maybe$Nothing = {$: 'Nothing'};
var author$project$Contact$initialModel = {form: author$project$Contact$init, hover: false, modal: elm$core$Maybe$Nothing, pageState: author$project$Contact$Editting, sending: false, submitted: false};
var elm$core$Basics$True = {$: 'True'};
var elm$core$Result$isOk = function (result) {
	if (result.$ === 'Ok') {
		return true;
...
var author$project$Contact$ClickedCloseModal = {$: 'ClickedCloseModal'};
var author$project$Contact$GotResized = function (a) {
	return {$: 'GotResized', a: a};
};
var author$project$Contact$NoOp = {$: 'NoOp'};
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				author$project$Contact$subscriptions(model.contact))
			]));
};
...
var author$project$Contact$Contact = F6(
	function (name, kana, email, tel, content, images) {
		return {content: content, email: email, images: images, kana: kana, name: name, tel: tel};
	});
...
var author$project$Error$Required = {$: 'Required'};
...
var author$project$Inquiry$Content$decoder = A2(
	...
	author$project$Inquiry$Content$Content,
	A2(
...
var author$project$Email$MissingHostName = {$: 'MissingHostName'};
var author$project$Email$TooLongEmail = {$: 'TooLongEmail'};
var author$project$Email$UnexpectedEnd = {$: 'UnexpectedEnd'};
var author$project$Email$InvalidSubdomain = {$: 'InvalidSubdomain'};
var author$project$Email$InvalidTld = {$: 'InvalidTld'};
var author$project$Email$EmptyHostName = {$: 'EmptyHostName'};
var elm$parser$Parser$Advanced$Bad = F2(
	function (a, b) {
		return {$: 'Bad', a: a, b: b};
	});
...
var author$project$Email$TooLongLocalPart = {$: 'TooLongLocalPart'};
var author$project$Email$UnexpectedChar = {$: 'UnexpectedChar'};
var elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return elm$parser$Parser$Advanced$Parser(
			function (s) {
...
var author$project$Inquiry$Kana$decoder = A2(
	arowM$elm_form_decoder$Form$Decoder$map,
	author$project$Inquiry$Kana$Kana,
	A2(
		arowM$elm_form_decoder$Form$Decoder$assert,
		A2(
			arowM$elm_form_decoder$Form$Decoder$maxLength,
...
var author$project$Inquiry$Name$decoder = A2(
	arowM$elm_form_decoder$Form$Decoder$map,
	author$project$Inquiry$Name$Name,
	A2(
		arowM$elm_form_decoder$Form$Decoder$assert,
		A2(
			arowM$elm_form_decoder$Form$Decoder$maxLength,
...
var author$project$Inquiry$Tel$decoder = A2(
	arowM$elm_form_decoder$Form$Decoder$map,
	elm$core$Maybe$map(author$project$Inquiry$Tel$Tel),
...
var author$project$Contact$Response = F2(
	function (received, messageId) {
		return {messageId: messageId, received: received};
	});
			...
			_List_fromArray(
				[
					...
					elm$json$Json$Encode$string(
						author$project$Inquiry$Email$toString(contact.email))),
					_Utils_Tuple2(
					'name',
					elm$json$Json$Encode$string(
						author$project$Inquiry$Name$toString(contact.name))),
					_Utils_Tuple2(
					'kana',
					elm$json$Json$Encode$string(
						author$project$Inquiry$Kana$toString(contact.kana))),
					_Utils_Tuple2(
					'tel',
					elm$json$Json$Encode$string(
						A2(
							elm$core$Maybe$withDefault,
							'',
							A2(elm$core$Maybe$map, author$project$Inquiry$Tel$toString, contact.tel)))),
					_Utils_Tuple2(
					'content',
					elm$json$Json$Encode$string(
						author$project$Inquiry$Content$toString(contact.content))),
					_Utils_Tuple2(
					'images',
					A2(elm$json$Json$Encode$list, elm$json$Json$Encode$string, contact.images))
				])));
...
var author$project$Contact$update = F2(
	function (msg, model) {
		...
		switch (msg.$) {
			case 'ClickedConfirm':
				var _n1 = A2(arowM$elm_form_decoder$Form$Decoder$run, author$project$Contact$decoder, model.form);
				if (_n1.$ === 'Ok') {
					var contact = _n1.a;
					return _Utils_Tuple2(
						_Utils_update(
					...
					function (m) {
						...
						setContactForm(
							_Utils_update(
								...
								{
									images: _Utils_ap(
										A2(elm$core$List$take, index, form.images),
										A2(elm$core$List$drop, index + 1, form.images))
								}))),
					elm$core$Platform$Cmd$none);
			case 'Enlarge':
				var index = msg.a;
					...
					_Utils_update(
						model,
						{
							modal: A2(
								...
								elm$core$List$head(
									A2(elm$core$List$drop, index, model.form.images)))
						}),
					elm$core$Platform$Cmd$none);
...
var author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'DeviceClassified') {
			...
			var subMsg = msg.a;
			var _n1 = A2(author$project$Contact$update, subMsg, model.contact);
			var newModel = _n1.a;
			var cmd = _n1.b;
			return _Utils_Tuple2(
				_Utils_update(
...
var author$project$Contact$ClickedBack = {$: 'ClickedBack'};
var author$project$Contact$ClickedSend = function (a) {
	return {$: 'ClickedSend', a: a};
};
	...
	function (device, contact) {
		...
		return _List_fromArray(
			[
				...
				field,
				'お名前（漢字）',
				author$project$Inquiry$Name$toString(contact.name) + '\u3000様'),
				divider,
				A2(
				field,
				'お名前（ふりがな）',
...
var author$project$Contact$labelBase = F2(
	function (_n0, device) {
		var labelString = _n0.labelString;
...
var author$project$Contact$DragEnter = {$: 'DragEnter'};
var author$project$Contact$DragLeave = {$: 'DragLeave'};
var author$project$Contact$Pick = {$: 'Pick'};
	...
	function (device, model) {
		...
		if (_Utils_eq(model.form.images, _List_Nil)) {
			...
			return A2(
				...
				function () {
					if (elm$core$List$length(model.form.images) >= 10) {
						return A2(
						...
						var restLabel = '残り' + (elm$core$String$fromInt(
							10 - elm$core$List$length(model.form.images)) + '枚登録可能');
			...
			[
				...
				_List_fromArray(
					[
						...
						A2(
						author$project$Contact$errorTip,
						form.agreement ? elm$core$Maybe$Nothing : ((!submitted) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just('プラバシーポリシーへの同意が認められておりません。')),
						device)
					])),
				A2(
				mdgriffith$elm_ui$Element$el,
...
var author$project$Contact$ClickedResend = {$: 'ClickedResend'};
var author$project$Contact$viewSent = function (response) {
	return _List_fromArray(
		[
			...
			mdgriffith$elm_ui$Element$el,
			_List_Nil,
			mdgriffith$elm_ui$Element$text('受信日時：' + response.received)),
			A2(
			mdgriffith$elm_ui$Element$paragraph,
			_List_Nil,
			_List_fromArray(
...
var author$project$Color$Darkest = {$: 'Darkest'};
...
var author$project$Contact$view = F2(
	function (device, model) {
		...
		return A2(
			...
			attrs,
			_Utils_ap(
				author$project$Contact$viewTop(model.pageState),
				function () {
...
var author$project$Main$view = function (model) {
	return A2(
		...
		A2(
			...
			author$project$Main$ContactMsg,
			A2(author$project$Contact$view, model.device, model.contact)));
};
var elm$browser$Browser$element = _Browser_element;
var author$project$Main$main = elm$browser$Browser$element(
...
_Platform_export({'Main':{'init':author$project$Main$main(
	A2(
		...
		A2(elm$json$Json$Decode$field, 'width', elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Element.Device":{"args":[],"type":"{ class : Element.DeviceClass, orientation : Element.Orientation }"},"Contact.Contact":{"args":[],"type":"{ name : Inquiry.Name.Name, kana : Inquiry.Kana.Kana, email : Inquiry.Email.Email, tel : Maybe.Maybe Inquiry.Tel.Tel, content : Inquiry.Content.Content, images : List.List String.String }"},"Contact.Response":{"args":[],"type":"{ received : String.String, messageId : String.String }"},"Inquiry.Email.Email":{"args":[],"type":"Email.Email"}},"unions":{"Main.Msg":{"args":[],"tags":{"DeviceClassified":["Element.Device"],"ContactMsg":["Contact.Msg"]}},"Contact.Msg":{"args":[],"tags":{"ClickedConfirm":[],"ClickedBack":[],"ClickedSend":["Contact.Contact"],"ClickedResend":[],"SentMail":["Contact.Contact","Result.Result Http.Error Contact.Response"],"Pick":[],"DragEnter":[],"DragLeave":[],"GotFiles":["File.File","List.List File.File"],"GotPreviews":["List.List String.String"],"GotResized":["Json.Encode.Value"],"Remove":["Basics.Int"],"Enlarge":["Basics.Int"],"ClickedCloseModal":[],"NoOp":[],"ChangedName":["String.String"],"ChangedKana":["String.String"],"ChangedTel":["String.String"],"ChangedEmail":["String.String"],"ChangedContent":["String.String"],"ClickedAgreement":["Basics.Bool"]}},"Element.DeviceClass":{"args":[],"tags":{"Phone":[],"Tablet":[],"Desktop":[],"BigDesktop":[]}},"Element.Orientation":{"args":[],"tags":{"Portrait":[],"Landscape":[]}},"Email.Email":{"args":[],"tags":{"Email":["String.String"]}},"Inquiry.Content.Content":{"args":[],"tags":{"Content":["String.String"]}},"Inquiry.Kana.Kana":{"args":[],"tags":{"Kana":["String.String"]}},"Inquiry.Name.Name":{"args":[],"tags":{"Name":["String.String"]}},"Inquiry.Tel.Tel":{"args":[],"tags":{"Tel":["String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"File.File":{"args":[],"tags":{"File":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}}}}})}});
...
var calendar = require('../elm-calendar/src/CompanyHoliday.elm');
...
var contact = require('../elm-contact-form/src/Main.elm');
...
if (nodeContact) {
  var resizeImage = function resizeImage(src) {
    return new Promise(function (resolve, reject) {
      ...
      image.onload = function () {
        ...
        var result = ctx.canvas.toDataURL('image/jpeg', 0.85);
        resolve(result);
      };
  ...
  var _app = contact.Elm.Main.init({
    node: nodeContact,
    flags: {
  ...
  _app.ports.resize.subscribe(function (data) {
    Promise.all(data.map(resizeImage)).then(function (resized) {
      _app.ports.resizedImages.send(resized);
    });
  });
...
},{"../css/style.scss":"../css/style.scss","./holiday.json":"holiday.json","./special.json":"special.json","../elm-calendar/src/CompanyHoliday.elm":"../elm-calendar/src/CompanyHoliday.elm","../elm-contact-form/src/Main.elm":"../elm-contact-form/src/Main.elm"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "64005" + '/');
