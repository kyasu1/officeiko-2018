...
})({"fu47D":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "63a03d301e7d7791";
"use strict";
...
// }
// Contact Form
var _mainElm = require("../elm-contact-form/src/Main.elm");
var _mainElmDefault = parcelHelpers.interopDefault(_mainElm);
// GLightbox Support
...
if (nodeContact) {
    const app = _mainElmDefault.default.Elm.Main.init({
        node: nodeContact,
        flags: {
...
if (btnOpenNav) btnOpenNav.addEventListener('click', ()=>{
    document.getElementById("side-nav").style.width = "100%";
});
const btnCloseNav = document.getElementById('btnCloseNav');
if (btnCloseNav) btnCloseNav.addEventListener('click', ()=>{
...
//   loop: true,
// });
const lightbox = _glightboxDefault.default({
    selector: 'glightbox',
    touchNavigation: true,
    loop: true,
    autoplayVideos: true,
...
},{"../css/style.scss":"efzMA","../elm-contact-form/src/Main.elm":"iMF5K","glightbox":"amQqY","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"efzMA":[function() {},{}],"iMF5K":[function(require,module,exports) {
(function(scope) {
...
*/ var _Scheduler_working = false;
    ...
    var $elm$browser$Debugger$Overlay$viewImportExport = F3(function(props, importMsg, exportMsg) {
        return A2($elm$html$Html$div, props, _List_fromArray([
    ...
    var $elm$browser$Debugger$Overlay$viewMiniControls = F2(function(config, numMsgs) {
        return A2($elm$html$Html$div, _List_fromArray([
            ...
            A2($elm$html$Html$div, _List_fromArray([
                ...
                $elm$html$Html$text('Explore History (' + ($elm$core$String$fromInt(numMsgs) + ')'))
            ])),
    ...
    var $elm$browser$Debugger$Main$viewResumeButton = function(maybeIndex) {
        if (maybeIndex.$ === 'Nothing') return $elm$html$Html$text('');
    ...
    var $elm$browser$Debugger$History$viewSnapshot = F3(function(currentIndex, index, _v0) {
    ...
    var $elm$browser$Debugger$History$consSnapshot = F3(function(currentIndex, snapshot, _v0) {
        var index = _v0.a;
        var rest = _v0.b;
    ...
    var $elm$browser$Debugger$History$view = F2(function(maybeIndex, _v0) {
        ...
        var _v1 = function() {
            if (maybeIndex.$ === 'Nothing') return _Utils_Tuple2(-1, 'calc(100% - 24px)');
            else {
                var i = maybeIndex.a;
        ...
        ]), A2($elm$core$List$cons, $elm$browser$Debugger$History$styles, A2($elm$core$List$cons, oldStuff, newStuff)));
    });
    var $elm$browser$Debugger$Main$viewSidebar = F2(function(state, history) {
        var maybeIndex = function() {
            if (state.$ === 'Running') return $elm$core$Maybe$Nothing;
            else {
                var index = state.a;
    ...
    var $elm$browser$Debugger$Main$popoutView = function(_v0) {
        ...
        return A3($elm$html$Html$node, 'body', _List_fromArray([
            ...
            A2($elm$html$Html$map, $elm$browser$Debugger$Main$ExpandoMsg, A2($elm$html$Html$div, _List_fromArray([
                A2($elm$html$Html$Attributes$style, 'display', 'block'),
                A2($elm$html$Html$Attributes$style, 'float', 'left'),
                A2($elm$html$Html$Attributes$style, 'height', '100%'),
    ...
    var $elm$browser$Debugger$Main$download = F2(function(metadata, history) {
        var json = $elm$json$Json$Encode$object(_List_fromArray([
    ...
    var $elm$browser$Debugger$Main$wrapUpdate = F3(function(update, msg, model) {
        wrapUpdate: while(true)switch(msg.$){
            ...
            case 'Open':
                return _Utils_Tuple2(model, A2($elm$core$Task$perform, function(_v5) {
                    return $elm$browser$Debugger$Main$NoOp;
            ...
            case 'Up':
                var index = function() {
                    ...
                    if (_v6.$ === 'Paused') {
                        var i = _v6.a;
                        return i;
                    } else return $elm$browser$Debugger$History$size(model.history);
                }();
                if (index > 0) {
                    var $temp$update = update, $temp$msg = $elm$browser$Debugger$Main$Jump(index - 1), $temp$model = model;
                    update = $temp$update;
                    msg = $temp$msg;
                    model = $temp$model;
                    continue wrapUpdate;
            ...
            case 'Down':
                var _v7 = model.state;
                if (_v7.$ === 'Running') return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
                else {
                    var index = _v7.a;
                    var userModel = _v7.c;
            ...
            case 'Import':
                return A2($elm$browser$Debugger$Main$withGoodMetadata, model, function(_v8) {
            ...
            default:
                ...
                if (_v10.$ === 'Nothing') return _Utils_Tuple2(_Utils_update(model, {
                    overlay: $elm$browser$Debugger$Overlay$none
                }), $elm$core$Platform$Cmd$none);
                else {
    ...
    var $mdgriffith$elm_ui$Element$BigDesktop = {
        $: 'BigDesktop'
    };
    var $mdgriffith$elm_ui$Element$Desktop = {
        $: 'Desktop'
    };
    var $mdgriffith$elm_ui$Element$Landscape = {
        $: 'Landscape'
    };
    var $mdgriffith$elm_ui$Element$Phone = {
        $: 'Phone'
    };
    var $mdgriffith$elm_ui$Element$Portrait = {
        $: 'Portrait'
    };
    var $mdgriffith$elm_ui$Element$Tablet = {
        $: 'Tablet'
    };
    ...
    var $author$project$Contact$Editting = {
        $: 'Editting'
    };
    var $author$project$Contact$init = {
        agreement: false,
        content: '',
        email: '',
        images: _List_Nil,
    ...
    var $author$project$Contact$initialModel = {
        form: $author$project$Contact$init,
        hover: false,
        modal: $elm$core$Maybe$Nothing,
        pageState: $author$project$Contact$Editting,
        sending: false,
        submitted: false
    };
    var $author$project$Main$init = function(flags) {
        return _Utils_Tuple2({
            contact: $author$project$Contact$initialModel,
            device: $mdgriffith$elm_ui$Element$classifyDevice(flags)
        }, $elm$core$Platform$Cmd$none);
    };
    ...
    var $author$project$Contact$ClickedCloseModal = {
        $: 'ClickedCloseModal'
    };
    ...
    var $author$project$Contact$NoOp = {
        $: 'NoOp'
    };
    ...
    var $author$project$Contact$onEscape = F2(function(action, noop) {
        return $elm$browser$Browser$Events$onKeyDown(A2($elm$json$Json$Decode$map, function(k) {
            if (k === 'Escape') return action;
            else return noop;
    ...
    var $author$project$Contact$subscriptions = function(model) {
        var _v0 = model.modal;
        if (_v0.$ === 'Just') return A2($author$project$Contact$onEscape, $author$project$Contact$ClickedCloseModal, $author$project$Contact$NoOp);
        else return $author$project$Contact$resizedImages($author$project$Contact$GotResized);
    };
    var $author$project$Main$subscriptions = function(model) {
        return $elm$core$Platform$Sub$batch(_List_fromArray([
            $elm$browser$Browser$Events$onResize(F2(function(width, height) {
                return $author$project$Main$DeviceClassified($mdgriffith$elm_ui$Element$classifyDevice({
                    height: height,
                    width: width
                }));
            })),
            A2($elm$core$Platform$Sub$map, $author$project$Main$ContactMsg, $author$project$Contact$subscriptions(model.contact))
        ]));
    };
    var $author$project$Contact$Confirming = F2(function(a, b) {
        return {
            $: 'Confirming',
            a: a,
            b: b
    ...
    var $author$project$Contact$GotFiles = F2(function(a, b) {
        return {
            $: 'GotFiles',
            a: a,
            b: b
    ...
    var $author$project$Contact$Contact = F6(function(name, kana, email, tel, content, images) {
        return {
            content: content,
            email: email,
            images: images,
    ...
    var $author$project$Inquiry$Content$Content = function(a) {
        return {
            $: 'Content',
            a: a
        };
    ...
    var $arowM$elm_form_decoder$Form$Decoder$run = F2(function(_v0, a) {
        var f = _v0.a;
        return f(a);
    });
    var $arowM$elm_form_decoder$Form$Decoder$assert = F2(function(v, _v0) {
        var f = _v0.a;
        return $arowM$elm_form_decoder$Form$Decoder$custom(function(a) {
            return A2($elm$core$Result$andThen, function(x) {
                return A2($elm$core$Result$map, function(_v1) {
                    return x;
    ...
    var $arowM$elm_form_decoder$Form$Decoder$map = F2(function(f, _v0) {
        var g = _v0.a;
        return $arowM$elm_form_decoder$Form$Decoder$custom(A2($elm$core$Basics$composeL, $elm$core$Result$map(f), g));
    });
    var $arowM$elm_form_decoder$Form$Decoder$maxLength = F2(function(err, bound) {
        return $arowM$elm_form_decoder$Form$Decoder$custom(function(str) {
            return _Utils_cmp($elm$core$String$length(str), bound) < 1 ? $elm$core$Result$Ok(_Utils_Tuple0) : $elm$core$Result$Err(_List_fromArray([
                err
            ]));
        });
    });
    var $author$project$Error$Required = {
        $: 'Required'
    };
    var $author$project$Error$required = $author$project$Error$Required;
    var $arowM$elm_form_decoder$Form$Decoder$fail = function(err) {
        return $arowM$elm_form_decoder$Form$Decoder$custom(function(_v0) {
    ...
    var $arowM$elm_form_decoder$Form$Decoder$with = function(f) {
        return $arowM$elm_form_decoder$Form$Decoder$custom(function(a) {
            return A2($arowM$elm_form_decoder$Form$Decoder$run, f(a), a);
        });
    };
    var $author$project$Form$Decoder$Extra$required = F2(function(err, d) {
        return $arowM$elm_form_decoder$Form$Decoder$with(function(s) {
            return s === '' ? $arowM$elm_form_decoder$Form$Decoder$fail(err) : d;
        });
    });
    var $author$project$Inquiry$Content$decoder = A2($arowM$elm_form_decoder$Form$Decoder$map, $author$project$Inquiry$Content$Content, A2($arowM$elm_form_decoder$Form$Decoder$assert, A2($arowM$elm_form_decoder$Form$Decoder$maxLength, $author$project$Error$invalid('500文字以内で入力をお願いします'), 500), A2($author$project$Form$Decoder$Extra$required, $author$project$Error$required, $arowM$elm_form_decoder$Form$Decoder$identity)));
    var $arowM$elm_form_decoder$Form$Decoder$lift = F2(function(f, _v0) {
        var g = _v0.a;
        return $arowM$elm_form_decoder$Form$Decoder$custom(A2($elm$core$Basics$composeL, g, f));
    });
    var $author$project$Contact$decoderContent = A2($arowM$elm_form_decoder$Form$Decoder$lift, function($) {
        return $.content;
    }, $author$project$Inquiry$Content$decoder);
    var $arowM$elm_form_decoder$Form$Decoder$andThen = F2(function(f, _v0) {
        var g = _v0.a;
        return $arowM$elm_form_decoder$Form$Decoder$custom(function(a) {
            var _v1 = g(a);
            if (_v1.$ === 'Err') {
                ...
                var x = _v1.a;
                return A2($arowM$elm_form_decoder$Form$Decoder$run, f(x), a);
            }
        });
    });
    ...
    var $author$project$Email$MissingHostName = {
        $: 'MissingHostName'
    };
    ...
    var $author$project$Email$TooLongEmail = {
        $: 'TooLongEmail'
    };
    var $author$project$Email$UnexpectedEnd = {
        $: 'UnexpectedEnd'
    };
    ...
    var $author$project$Email$InvalidSubdomain = {
        $: 'InvalidSubdomain'
    };
    var $author$project$Email$InvalidTld = {
        $: 'InvalidTld'
    };
    ...
    var $author$project$Email$EmptyHostName = {
        $: 'EmptyHostName'
    };
    ...
    var $author$project$Email$hostParser = A2($elm$parser$Parser$Advanced$andThen, function(s) {
    ...
    }, $elm$parser$Parser$Advanced$getChompedString(A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity), $elm$parser$Parser$Advanced$chompWhile(function(c) {
        return $elm$core$Char$isAlphaNum(c) || _Utils_eq(c, _Utils_chr('-')) || _Utils_eq(c, _Utils_chr('_'));
    }))));
    ...
    var $author$project$Email$domainHelper = function(revStrings) {
        return $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
            A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed(function(string) {
                return $elm$parser$Parser$Advanced$Loop(A2($elm$core$List$cons, string, revStrings));
            }), $elm$parser$Parser$Advanced$symbol(A2($elm$parser$Parser$Advanced$Token, '.', $author$project$Email$ExpectingSymbol('.')))), $author$project$Email$hostParser),
            A2($elm$parser$Parser$Advanced$map, function(_v0) {
                return $elm$parser$Parser$Advanced$Done($elm$core$List$reverse(revStrings));
    ...
    var $author$project$Email$tldCheck = function(s) {
        return !$elm$core$List$length(A2($elm$core$List$filter, A2($elm$core$Basics$composeL, $elm$core$Basics$not, $elm$core$Char$isAlpha), $elm$core$String$toList(s)));
    };
    var $author$project$Email$domainsParser = A2($elm$parser$Parser$Advanced$andThen, function(listOfString) {
        var _v0 = $elm$core$List$reverse(listOfString);
        if (!_v0.b) return $elm$parser$Parser$Advanced$problem($author$project$Email$InvalidSubdomain);
        else {
            var hd = _v0.a;
    ...
    var $author$project$Email$TooLongLocalPart = {
        $: 'TooLongLocalPart'
    };
    var $author$project$Email$UnexpectedChar = {
        $: 'UnexpectedChar'
    };
    ...
    var $author$project$Email$localParser = A2($elm$parser$Parser$Advanced$andThen, function(s) {
    ...
    }, $elm$parser$Parser$Advanced$getChompedString(A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity), A2($elm$parser$Parser$Advanced$chompIf, $elm$core$Char$isAlpha, $author$project$Email$UnexpectedChar)), $elm$parser$Parser$Advanced$chompWhile(function(c) {
        return $elm$core$Char$isAlphaNum(c) || _Utils_eq(c, _Utils_chr('.')) || _Utils_eq(c, _Utils_chr('-')) || _Utils_eq(c, _Utils_chr('_'));
    }))));
    var $author$project$Email$parser = A2($elm$parser$Parser$Advanced$andThen, function(_v0) {
        var local = _v0.a;
        var host = _v0.b;
        var hosts = _v0.c;
        ...
        } else return $elm$parser$Parser$Advanced$problem($author$project$Email$MissingHostName);
    }, A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, $elm$parser$Parser$Advanced$succeed(F3(function(local, host, hosts) {
        return _Utils_Tuple3(local, host, hosts);
    })), A2($elm$parser$Parser$Advanced$ignorer, $author$project$Email$localParser, $elm$parser$Parser$Advanced$symbol(A2($elm$parser$Parser$Advanced$Token, '@', $author$project$Email$ExpectingSymbol('@'))))), $author$project$Email$hostParser), A2($elm$parser$Parser$Advanced$ignorer, $author$project$Email$domainsParser, $elm$parser$Parser$Advanced$end($author$project$Email$UnexpectedEnd))));
    ...
    var $author$project$Email$decoder = $arowM$elm_form_decoder$Form$Decoder$custom(function(input) {
        var _v0 = A2($elm$parser$Parser$Advanced$run, $author$project$Email$parser, input);
        if (_v0.$ === 'Ok') {
            var email = _v0.a;
            return $elm$core$Result$Ok($author$project$Email$Email(email));
        } else {
            var problems = _v0.a;
            return $elm$core$Result$Err(A2($elm$core$List$map, function($) {
                return $.problem;
            }, problems));
        }
    });
    ...
    var $arowM$elm_form_decoder$Form$Decoder$mapError = F2(function(f, _v0) {
        var g = _v0.a;
        return $arowM$elm_form_decoder$Form$Decoder$custom(A2($elm$core$Basics$composeL, $elm$core$Result$mapError($elm$core$List$map(f)), g));
    });
    ...
    var $author$project$Inquiry$Email$decoder = A2($arowM$elm_form_decoder$Form$Decoder$andThen, function(_v0) {
    ...
    var $author$project$Contact$decoderEmail = A2($arowM$elm_form_decoder$Form$Decoder$lift, function($) {
        return $.email;
    ...
    var $arowM$elm_form_decoder$Form$Decoder$prependListResult = F2(function(r1, r2) {
        var _v0 = _Utils_Tuple2(r1, r2);
        if (_v0.a.$ === 'Err') {
            if (_v0.b.$ === 'Err') {
                var err = _v0.a.a;
                var errs = _v0.b.a;
                return $elm$core$Result$Err(_Utils_ap(err, errs));
            } else {
                var err = _v0.a.a;
                return $elm$core$Result$Err(err);
            }
            ...
            var b = _v0.a.a;
            var bs = _v0.b.a;
            return $elm$core$Result$Ok(A2($elm$core$List$cons, b, bs));
        }
    });
    var $arowM$elm_form_decoder$Form$Decoder$list = function(d) {
        return $arowM$elm_form_decoder$Form$Decoder$custom(A2($elm$core$Basics$composeL, A2($elm$core$List$foldr, $arowM$elm_form_decoder$Form$Decoder$prependListResult, $elm$core$Result$Ok(_List_Nil)), $elm$core$List$map($arowM$elm_form_decoder$Form$Decoder$run(d))));
    };
    var $author$project$Form$Decoder$Extra$maxLengthList = F2(function(err, bound) {
        return $arowM$elm_form_decoder$Form$Decoder$custom(function(items) {
            return _Utils_cmp($elm$core$List$length(items), bound) < 1 ? $elm$core$Result$Ok(_Utils_Tuple0) : $elm$core$Result$Err(_List_fromArray([
                err
            ]));
        });
    });
    var $author$project$Contact$decoderImages = A2($arowM$elm_form_decoder$Form$Decoder$lift, function($) {
        return $.images;
    }, A2($arowM$elm_form_decoder$Form$Decoder$assert, A2($author$project$Form$Decoder$Extra$maxLengthList, $author$project$Error$invalid('添付可能な画像は10枚までです'), 10), $arowM$elm_form_decoder$Form$Decoder$list($author$project$Contact$decoderImageForm)));
    var $author$project$Inquiry$Kana$Kana = function(a) {
        return {
            $: 'Kana',
            a: a
        };
    };
    var $author$project$Inquiry$Kana$decoder = A2($arowM$elm_form_decoder$Form$Decoder$map, $author$project$Inquiry$Kana$Kana, A2($arowM$elm_form_decoder$Form$Decoder$assert, A2($arowM$elm_form_decoder$Form$Decoder$maxLength, $author$project$Error$invalid('50文字以内で入力をお願いします'), 50), A2($author$project$Form$Decoder$Extra$required, $author$project$Error$required, $arowM$elm_form_decoder$Form$Decoder$identity)));
    var $author$project$Contact$decoderKana = A2($arowM$elm_form_decoder$Form$Decoder$lift, function($) {
        return $.kana;
    }, $author$project$Inquiry$Kana$decoder);
    var $author$project$Inquiry$Name$Name = function(a) {
        return {
            $: 'Name',
            a: a
        };
    };
    var $author$project$Inquiry$Name$decoder = A2($arowM$elm_form_decoder$Form$Decoder$map, $author$project$Inquiry$Name$Name, A2($arowM$elm_form_decoder$Form$Decoder$assert, A2($arowM$elm_form_decoder$Form$Decoder$maxLength, $author$project$Error$invalid('50文字以内で入力をお願いします'), 50), A2($author$project$Form$Decoder$Extra$required, $author$project$Error$required, $arowM$elm_form_decoder$Form$Decoder$identity)));
    var $author$project$Contact$decoderName = A2($arowM$elm_form_decoder$Form$Decoder$lift, function($) {
        return $.name;
    }, $author$project$Inquiry$Name$decoder);
    var $author$project$Inquiry$Tel$Tel = function(a) {
        return {
            $: 'Tel',
            a: a
        };
    ...
    var $author$project$Inquiry$Tel$decoder = A2($arowM$elm_form_decoder$Form$Decoder$map, $elm$core$Maybe$map($author$project$Inquiry$Tel$Tel), $author$project$Form$Decoder$Extra$optional($arowM$elm_form_decoder$Form$Decoder$identity));
    var $author$project$Contact$decoderTel = A2($arowM$elm_form_decoder$Form$Decoder$lift, function($) {
        return $.tel;
    }, $author$project$Inquiry$Tel$decoder);
    var $arowM$elm_form_decoder$Form$Decoder$field = F2(function(_v0, _v1) {
        var f = _v0.a;
        var g = _v1.a;
        return $arowM$elm_form_decoder$Form$Decoder$custom(function(i) {
            var _v2 = _Utils_Tuple2(g(i), f(i));
            if (_v2.a.$ === 'Ok') {
                var h = _v2.a.a;
                var res = _v2.b;
                ...
                var gErr = _v2.a.a;
                var fErr = _v2.b.a;
                return $elm$core$Result$Err(_Utils_ap(gErr, fErr));
            } else {
                var gErr = _v2.a.a;
    ...
    var $author$project$Contact$decoder = $arowM$elm_form_decoder$Form$Decoder$with(function(form) {
        return form.agreement ? A2($arowM$elm_form_decoder$Form$Decoder$field, $author$project$Contact$decoderImages, A2($arowM$elm_form_decoder$Form$Decoder$field, $author$project$Contact$decoderContent, A2($arowM$elm_form_decoder$Form$Decoder$field, $author$project$Contact$decoderTel, A2($arowM$elm_form_decoder$Form$Decoder$field, $author$project$Contact$decoderEmail, A2($arowM$elm_form_decoder$Form$Decoder$field, $author$project$Contact$decoderKana, A2($arowM$elm_form_decoder$Form$Decoder$field, $author$project$Contact$decoderName, $arowM$elm_form_decoder$Form$Decoder$top($author$project$Contact$Contact))))))) : $arowM$elm_form_decoder$Form$Decoder$fail($author$project$Error$invalid('同意が必要です'));
    });
    ...
    var $elm$file$File$Select$files = F2(function(mimes, toMsg) {
        return A2($elm$core$Task$perform, function(_v0) {
            var f = _v0.a;
            var fs = _v0.b;
    ...
    var $author$project$Contact$SentMail = F2(function(a, b) {
        return {
            $: 'SentMail',
            a: a,
            b: b
    ...
    var $author$project$Contact$awsUrl = 'https://x3j6ztpdkg.execute-api.us-west-2.amazonaws.com/prod/email/send';
    ...
    var $author$project$Contact$Response = F2(function(received, messageId) {
        return {
            messageId: messageId,
            received: received
        };
    ...
    var $author$project$Contact$responseDecoder = A3($elm$json$Json$Decode$map2, $author$project$Contact$Response, A2($elm$json$Json$Decode$field, 'Received', $elm$json$Json$Decode$string), A2($elm$json$Json$Decode$at, _List_fromArray([
        'Data',
        'MessageId'
    ...
    var $author$project$Contact$sendMail = function(contact) {
        var body = $elm$http$Http$jsonBody($elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2('email', $elm$json$Json$Encode$string($author$project$Inquiry$Email$toString(contact.email))),
            _Utils_Tuple2('name', $elm$json$Json$Encode$string($author$project$Inquiry$Name$toString(contact.name))),
            _Utils_Tuple2('kana', $elm$json$Json$Encode$string($author$project$Inquiry$Kana$toString(contact.kana))),
            _Utils_Tuple2('tel', $elm$json$Json$Encode$string(A2($elm$core$Maybe$withDefault, '', A2($elm$core$Maybe$map, $author$project$Inquiry$Tel$toString, contact.tel)))),
            _Utils_Tuple2('content', $elm$json$Json$Encode$string($author$project$Inquiry$Content$toString(contact.content))),
            _Utils_Tuple2('images', A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, contact.images))
        ])));
        return $elm$http$Http$post({
            body: body,
            expect: A2($elm$http$Http$expectJson, $author$project$Contact$SentMail(contact), $author$project$Contact$responseDecoder),
            url: $author$project$Contact$awsUrl
        });
    };
    ...
    var $author$project$Contact$update = F2(function(msg, model) {
        var form = model.form;
        ...
        switch(msg.$){
            case 'ClickedConfirm':
                var _v1 = A2($arowM$elm_form_decoder$Form$Decoder$run, $author$project$Contact$decoder, model.form);
                if (_v1.$ === 'Ok') {
                    var contact = _v1.a;
                    return _Utils_Tuple2(_Utils_update(model, {
                        pageState: A2($author$project$Contact$Confirming, contact, $elm$core$Maybe$Nothing),
                        submitted: true
                    }), A2($elm$core$Task$perform, function(_v2) {
            ...
            case 'ClickedBack':
                return _Utils_Tuple2(_Utils_update(model, {
                    pageState: $author$project$Contact$Editting
                }), A2($elm$core$Task$perform, function(_v3) {
                    return $author$project$Contact$NoOp;
                }, A2($elm$browser$Browser$Dom$setViewport, 0, 0)));
            case 'ClickedSend':
                var contact = msg.a;
            ...
            case 'SentMail':
                if (msg.b.$ === 'Ok') {
                    ...
                    return _Utils_Tuple2(_Utils_update(model, {
                        pageState: $author$project$Contact$Sent(response),
                        sending: false
                    ...
                    var err = msg.b.a;
                    return _Utils_Tuple2(_Utils_update(model, {
                        pageState: A2($author$project$Contact$Confirming, contact, $elm$core$Maybe$Just('通信エラーが発生しました')),
                        sending: false
                    }), $elm$core$Platform$Cmd$none);
                }
            case 'Pick':
                return _Utils_Tuple2(model, A2($elm$file$File$Select$files, $author$project$Contact$acceptedFileTypes, $author$project$Contact$GotFiles));
            case 'DragEnter':
                return _Utils_Tuple2(_Utils_update(model, {
                    hover: true
                }), $elm$core$Platform$Cmd$none);
            ...
            case 'GotFiles':
                var file = msg.a;
                var files = msg.b;
                var validFiles = A2($elm$core$List$filter, function(item) {
                    return A2($elm$core$List$any, function(mime) {
                        return _Utils_eq($elm$file$File$mime(item), mime);
                    }, $author$project$Contact$acceptedFileTypes);
                }, A2($elm$core$List$cons, file, files));
                return _Utils_Tuple2(_Utils_update(model, {
                    hover: false
                }), A2($elm$core$Task$perform, $author$project$Contact$GotPreviews, $elm$core$Task$sequence(A2($elm$core$List$map, $elm$file$File$toUrl, validFiles))));
            case 'GotPreviews':
                var urls = msg.a;
                return _Utils_Tuple2(setContactForm(_Utils_update(form, {
                    images: A2($elm$core$List$take, 10, _Utils_ap(form.images, A2($elm$core$List$repeat, $elm$core$List$length(urls), '')))
                })), $author$project$Contact$resize(A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, urls)));
            case 'GotResized':
                var value = msg.a;
                var _v5 = A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$list($elm$json$Json$Decode$string), value);
                if (_v5.$ === 'Ok') {
                    var urls = _v5.a;
                    return _Utils_Tuple2(setContactForm(_Utils_update(form, {
                        images: A2($elm$core$List$take, 10, _Utils_ap(A2($elm$core$List$filter, function(url) {
                            return url !== '';
                        }, form.images), urls))
                    })), $elm$core$Platform$Cmd$none);
                } else {
            ...
            case 'Remove':
                var index = msg.a;
                return _Utils_Tuple2(function(m) {
                    return _Utils_update(m, {
                        modal: $elm$core$Maybe$Nothing
                    });
                }(setContactForm(_Utils_update(form, {
                    images: _Utils_ap(A2($elm$core$List$take, index, form.images), A2($elm$core$List$drop, index + 1, form.images))
                }))), $elm$core$Platform$Cmd$none);
            case 'Enlarge':
                var index = msg.a;
                return _Utils_Tuple2(_Utils_update(model, {
                    modal: A2($elm$core$Maybe$map, function(s) {
                        return _Utils_Tuple2(index, s);
                    }, $elm$core$List$head(A2($elm$core$List$drop, index, model.form.images)))
                }), $elm$core$Platform$Cmd$none);
            case 'ClickedCloseModal':
                return _Utils_Tuple2(_Utils_update(model, {
                    modal: $elm$core$Maybe$Nothing
                }), $elm$core$Platform$Cmd$none);
            case 'NoOp':
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        if (msg.$ === 'DeviceClassified') {
            ...
            var subMsg = msg.a;
            var _v1 = A2($author$project$Contact$update, subMsg, model.contact);
            var newModel = _v1.a;
            var cmd = _v1.b;
            return _Utils_Tuple2(_Utils_update(model, {
                contact: newModel
    ...
    var $mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function(focus) {
        return A2($mdgriffith$elm_ui$Internal$Model$Style, $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.any) + (':focus .focusable, ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.any) + '.focusable:focus')), A2($elm$core$List$filterMap, $elm$core$Basics$identity, _List_fromArray([
    ...
    var $mdgriffith$elm_ui$Internal$Style$baseSheet = _List_fromArray([
        ...
        A2($mdgriffith$elm_ui$Internal$Style$Class, $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.any), _List_fromArray([
            ...
            A2($mdgriffith$elm_ui$Internal$Style$Descriptor, $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.paragraph), _List_fromArray([
                ...
                A2($mdgriffith$elm_ui$Internal$Style$Child, $mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.single), _List_fromArray([
                    A2($mdgriffith$elm_ui$Internal$Style$Prop, 'display', 'inline'),
                    A2($mdgriffith$elm_ui$Internal$Style$Prop, 'white-space', 'normal'),
    ...
    var $mdgriffith$elm_ui$Internal$Model$staticRoot = A3($elm$virtual_dom$VirtualDom$node, 'style', _List_Nil, _List_fromArray([
    ...
    var $mdgriffith$elm_ui$Internal$Model$toStyleSheetString = F2(function(options, stylesheet) {
        var renderStyle = F3(function(maybePseudo, selector, props) {
            if (maybePseudo.$ === 'Nothing') return selector + ('{' + (A3($elm$core$List$foldl, $mdgriffith$elm_ui$Internal$Model$renderProps(false), '', props) + '\n}'));
            else {
                ...
                switch(pseudo.$){
                    case 'Hover':
                        ...
                        switch(_v17.$){
                            case 'NoHover':
                                return '';
                            case 'ForceHover':
                                return selector + ('-hv {' + (A3($elm$core$List$foldl, $mdgriffith$elm_ui$Internal$Model$renderProps(true), '', props) + '\n}'));
                            default:
                                return selector + ('-hv:hover {' + (A3($elm$core$List$foldl, $mdgriffith$elm_ui$Internal$Model$renderProps(false), '', props) + '\n}'));
                        }
                    case 'Focus':
                    ...
                    default:
                        return selector + ('-act:active {' + (A3($elm$core$List$foldl, $mdgriffith$elm_ui$Internal$Model$renderProps(false), '', props) + '\n}'));
                }
            }
        });
        var renderStyleRule = F2(function(rule, maybePseudo) {
            switch(rule.$){
                case 'Style':
                    var selector = rule.a;
                    var props = rule.b;
                ...
                case 'Shadows':
                    var name = rule.a;
                    var prop = rule.b;
                    return A3(renderStyle, maybePseudo, '.' + name, _List_fromArray([
                ...
                case 'FontSize':
                    var i = rule.a;
                    return A3(renderStyle, maybePseudo, '.font-size-' + $elm$core$String$fromInt(i), _List_fromArray([
                ...
                case 'Single':
                    ...
                    var prop = rule.b;
                    var val = rule.c;
                    return A3(renderStyle, maybePseudo, '.' + _class, _List_fromArray([
                ...
                case 'SpacingStyle':
                    ...
                    return $elm$core$String$concat(_List_fromArray([
                        A3(renderStyle, maybePseudo, _class + (row + (' > ' + (any + (' + ' + any)))), _List_fromArray([
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'margin-left', xPx)
                        ])),
                        A3(renderStyle, maybePseudo, _class + (wrappedRow + (' > ' + any)), _List_fromArray([
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'margin', halfY + (' ' + halfX))
                        ])),
                        A3(renderStyle, maybePseudo, _class + (column + (' > ' + (any + (' + ' + any)))), _List_fromArray([
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'margin-top', yPx)
                        ])),
                        A3(renderStyle, maybePseudo, _class + (page + (' > ' + (any + (' + ' + any)))), _List_fromArray([
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'margin-top', yPx)
                        ])),
                        A3(renderStyle, maybePseudo, _class + (page + (' > ' + left)), _List_fromArray([
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'margin-right', xPx)
                        ])),
                        A3(renderStyle, maybePseudo, _class + (page + (' > ' + right)), _List_fromArray([
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'margin-left', xPx)
                        ])),
                        A3(renderStyle, maybePseudo, _Utils_ap(_class, paragraph), _List_fromArray([
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'line-height', 'calc(1em + ' + ($elm$core$String$fromInt(y) + 'px)'))
                        ])),
                        A3(renderStyle, maybePseudo, 'textarea' + _class, _List_fromArray([
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'line-height', 'calc(1em + ' + ($elm$core$String$fromInt(y) + 'px)'))
                        ])),
                        A3(renderStyle, maybePseudo, _class + (paragraph + (' > ' + left)), _List_fromArray([
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'margin-right', xPx)
                        ])),
                        A3(renderStyle, maybePseudo, _class + (paragraph + (' > ' + right)), _List_fromArray([
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'margin-left', xPx)
                        ])),
                        A3(renderStyle, maybePseudo, _class + (paragraph + '::after'), _List_fromArray([
                        ...
                        A3(renderStyle, maybePseudo, _class + (paragraph + '::before'), _List_fromArray([
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'content', '\'\''),
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'display', 'block'),
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'height', '0'),
                            A2($mdgriffith$elm_ui$Internal$Model$Property, 'width', '0'),
                ...
                case 'PaddingStyle':
                    ...
                    var _class = '.' + cls;
                    return A3(renderStyle, maybePseudo, _class, _List_fromArray([
                        A2($mdgriffith$elm_ui$Internal$Model$Property, 'padding', $elm$core$String$fromInt(top) + ('px ' + ($elm$core$String$fromInt(right) + ('px ' + ($elm$core$String$fromInt(bottom) + ('px ' + ($elm$core$String$fromInt(left) + 'px')))))))
                    ]));
                case 'BorderWidth':
                    var cls = rule.a;
                    var top = rule.b;
                ...
                case 'PseudoSelector':
                    ...
                    var renderPseudoRule = function(style) {
                        return A2(renderStyleRule, style, $elm$core$Maybe$Just(_class));
                    };
                    return A2($elm$core$String$join, ' ', A2($elm$core$List$map, renderPseudoRule, styles));
                default:
                    ...
                    if (_v12.a.$ === 'Just' && _v12.b.$ === 'Just') {
                        var cls = _v12.a.a;
                        var v = _v12.b.a;
                        return A3(renderStyle, maybePseudo, '.' + cls, _List_fromArray([
        ...
        var combine = F2(function(style, rendered) {
            return {
                rules: _Utils_ap(rendered.rules, A2(renderStyleRule, style, $elm$core$Maybe$Nothing)),
                topLevel: (function() {
                    var _v14 = $mdgriffith$elm_ui$Internal$Model$topLevelValue(style);
                    if (_v14.$ === 'Nothing') return rendered.topLevel;
                    else {
                        var topLevel = _v14.a;
        ...
        var _v13 = A3($elm$core$List$foldl, combine, {
            rules: '',
            topLevel: _List_Nil
        }, stylesheet);
        var topLevel = _v13.topLevel;
        var rules = _v13.rules;
        return _Utils_ap($mdgriffith$elm_ui$Internal$Model$renderTopLevelValues(topLevel), rules);
    });
    var $mdgriffith$elm_ui$Internal$Model$toStyleSheet = F2(function(options, styleSheet) {
        return A3($elm$virtual_dom$VirtualDom$node, 'style', _List_Nil, _List_fromArray([
    ...
    var $mdgriffith$elm_ui$Internal$Model$embedKeyed = F4(function(_static, opts, styles, children) {
        return _static ? A2($elm$core$List$cons, _Utils_Tuple2('static-stylesheet', $mdgriffith$elm_ui$Internal$Model$staticRoot), A2($elm$core$List$cons, _Utils_Tuple2('dynamic-stylesheet', A2($mdgriffith$elm_ui$Internal$Model$toStyleSheet, opts, A3($elm$core$List$foldl, $mdgriffith$elm_ui$Internal$Model$reduceStyles, _Utils_Tuple2($elm$core$Set$empty, _List_fromArray([
            $mdgriffith$elm_ui$Internal$Model$renderFocusStyle(opts.focus)
        ])), styles).b)), children)) : A2($elm$core$List$cons, _Utils_Tuple2('dynamic-stylesheet', A2($mdgriffith$elm_ui$Internal$Model$toStyleSheet, opts, A3($elm$core$List$foldl, $mdgriffith$elm_ui$Internal$Model$reduceStyles, _Utils_Tuple2($elm$core$Set$empty, _List_fromArray([
            $mdgriffith$elm_ui$Internal$Model$renderFocusStyle(opts.focus)
        ])), styles).b)), children);
    });
    var $mdgriffith$elm_ui$Internal$Model$embedWith = F4(function(_static, opts, styles, children) {
        return _static ? A2($elm$core$List$cons, $mdgriffith$elm_ui$Internal$Model$staticRoot, A2($elm$core$List$cons, A2($mdgriffith$elm_ui$Internal$Model$toStyleSheet, opts, A3($elm$core$List$foldl, $mdgriffith$elm_ui$Internal$Model$reduceStyles, _Utils_Tuple2($elm$core$Set$empty, _List_fromArray([
            $mdgriffith$elm_ui$Internal$Model$renderFocusStyle(opts.focus)
        ])), styles).b), children)) : A2($elm$core$List$cons, A2($mdgriffith$elm_ui$Internal$Model$toStyleSheet, opts, A3($elm$core$List$foldl, $mdgriffith$elm_ui$Internal$Model$reduceStyles, _Utils_Tuple2($elm$core$Set$empty, _List_fromArray([
            $mdgriffith$elm_ui$Internal$Model$renderFocusStyle(opts.focus)
        ])), styles).b), children);
    });
    ...
    var $mdgriffith$elm_ui$Internal$Model$textElement = function(str) {
        return A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class(A2($elm$core$String$join, ' ', _List_fromArray([
                $mdgriffith$elm_ui$Internal$Style$classes.any,
                $mdgriffith$elm_ui$Internal$Style$classes.text,
    ...
    var $mdgriffith$elm_ui$Internal$Model$textElementFill = function(str) {
        return A3($elm$virtual_dom$VirtualDom$node, 'div', _List_fromArray([
            $elm$html$Html$Attributes$class(A2($elm$core$String$join, ' ', _List_fromArray([
                $mdgriffith$elm_ui$Internal$Style$classes.any,
                $mdgriffith$elm_ui$Internal$Style$classes.text,
    ...
    var $mdgriffith$elm_ui$Internal$Model$renderHeight = function(h) {
        switch(h.$){
            case 'Px':
                ...
                return _Utils_Tuple3($mdgriffith$elm_ui$Internal$Flag$none, name, _List_fromArray([
            ...
            case 'Fill':
                ...
                return portion === 1 ? _Utils_Tuple3(A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$heightFill, $mdgriffith$elm_ui$Internal$Flag$none), $mdgriffith$elm_ui$Internal$Style$classes.heightFill, _List_Nil) : _Utils_Tuple3(A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$heightFill, $mdgriffith$elm_ui$Internal$Flag$none), $mdgriffith$elm_ui$Internal$Style$classes.heightFillPortion + (' height-fill-' + $elm$core$String$fromInt(portion)), _List_fromArray([
                    A3($mdgriffith$elm_ui$Internal$Model$Single, $mdgriffith$elm_ui$Internal$Style$classes.any + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.row + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot('height-fill-' + $elm$core$String$fromInt(portion))))), 'flex-grow', $elm$core$String$fromInt(portion * 100000))
                ]));
            case 'Min':
                var minSize = h.a;
                var len = h.b;
                var cls = 'min-height-' + $elm$core$String$fromInt(minSize);
                var style = A3($mdgriffith$elm_ui$Internal$Model$Single, cls, 'min-height', $elm$core$String$fromInt(minSize) + 'px');
                ...
                case 'Width':
                    ...
                    if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$width, has)) {
                        ...
                        default:
                            ...
                            var newClass = _v4.b;
                            var newStyles = _v4.c;
                            var $temp$classes = classes + (' ' + newClass), $temp$node = node, $temp$has = A2($mdgriffith$elm_ui$Internal$Flag$merge, addToFlags, has), $temp$transform = transform, $temp$styles = _Utils_ap(newStyles, styles), $temp$attrs = attrs, $temp$children = children, $temp$elementAttrs = remaining;
                            classes = $temp$classes;
                            node = $temp$node;
                            has = $temp$has;
                            transform = $temp$transform;
                ...
                case 'Height':
                    ...
                    if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$height, has)) {
                        ...
                        case 'Px':
                            ...
                            var name = 'height-px-' + val;
                            var $temp$classes = name + (' ' + classes), $temp$node = node, $temp$has = A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$height, has), $temp$transform = transform, $temp$styles = A2($elm$core$List$cons, A3($mdgriffith$elm_ui$Internal$Model$Single, name, 'height ', val), styles), $temp$attrs = attrs, $temp$children = children, $temp$elementAttrs = remaining;
                            classes = $temp$classes;
                            node = $temp$node;
                            has = $temp$has;
                            transform = $temp$transform;
                ...
                case 'Describe':
                    ...
                    switch(description.$){
                        ...
                        case 'Paragraph':
                            ...
                            var $temp$classes = classes, $temp$node = newNode, $temp$has = has, $temp$transform = transform, $temp$styles = styles, $temp$attrs = attrs, $temp$children = children, $temp$elementAttrs = remaining;
                            classes = $temp$classes;
                            node = $temp$node;
                            has = $temp$has;
                            transform = $temp$transform;
    ...
    var $mdgriffith$elm_ui$Internal$Model$rootStyle = function() {
        ...
        return _List_fromArray([
            A2($mdgriffith$elm_ui$Internal$Model$StyleClass, $mdgriffith$elm_ui$Internal$Flag$bgColor, A3($mdgriffith$elm_ui$Internal$Model$Colored, 'bg-color-' + $mdgriffith$elm_ui$Internal$Model$formatColorClass(A4($mdgriffith$elm_ui$Internal$Model$Rgba, 1, 1, 1, 0)), 'background-color', A4($mdgriffith$elm_ui$Internal$Model$Rgba, 1, 1, 1, 0))),
            A2($mdgriffith$elm_ui$Internal$Model$StyleClass, $mdgriffith$elm_ui$Internal$Flag$fontColor, A3($mdgriffith$elm_ui$Internal$Model$Colored, 'font-color-' + $mdgriffith$elm_ui$Internal$Model$formatColorClass(A4($mdgriffith$elm_ui$Internal$Model$Rgba, 0, 0, 0, 1)), 'color', A4($mdgriffith$elm_ui$Internal$Model$Rgba, 0, 0, 0, 1))),
    ...
    var $mdgriffith$elm_ui$Element$paddingXY = F2(function(x, y) {
        return _Utils_eq(x, y) ? A2($mdgriffith$elm_ui$Internal$Model$StyleClass, $mdgriffith$elm_ui$Internal$Flag$padding, A5($mdgriffith$elm_ui$Internal$Model$PaddingStyle, 'p-' + $elm$core$String$fromInt(x), x, x, x, x)) : A2($mdgriffith$elm_ui$Internal$Model$StyleClass, $mdgriffith$elm_ui$Internal$Flag$padding, A5($mdgriffith$elm_ui$Internal$Model$PaddingStyle, 'p-' + ($elm$core$String$fromInt(x) + ('-' + $elm$core$String$fromInt(y))), y, x, y, x));
    });
    ...
    var $author$project$Contact$ClickedBack = {
        $: 'ClickedBack'
    };
    ...
    var $author$project$Color$Base = {
        $: 'Base'
    };
    var $author$project$Color$base = function(hue) {
        return hue($author$project$Color$Base);
    };
    ...
    var $mdgriffith$elm_ui$Element$Input$onKey = F2(function(desiredCode, msg) {
        ...
        return $mdgriffith$elm_ui$Internal$Model$Attr(A2($elm$html$Html$Events$preventDefaultOn, 'keyup', A2($elm$json$Json$Decode$map, function(fired) {
    ...
    var $mdgriffith$elm_ui$Element$Input$button = F2(function(attrs, _v0) {
        ...
        return A4($mdgriffith$elm_ui$Internal$Model$element, $mdgriffith$elm_ui$Internal$Model$asEl, $mdgriffith$elm_ui$Internal$Model$div, A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink), A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink), A2($elm$core$List$cons, $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.contentCenterX + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.contentCenterY + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.seButton + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.noTextSelection)))))), A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$pointer, A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$Input$focusDefault(attrs), A2($elm$core$List$cons, $mdgriffith$elm_ui$Internal$Model$Describe($mdgriffith$elm_ui$Internal$Model$Button), A2($elm$core$List$cons, $mdgriffith$elm_ui$Internal$Model$Attr($elm$html$Html$Attributes$tabindex(0)), function() {
            if (onPress.$ === 'Nothing') return A2($elm$core$List$cons, $mdgriffith$elm_ui$Internal$Model$Attr($elm$html$Html$Attributes$disabled(true)), attrs);
                ...
                var msg = onPress.a;
                return A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$Events$onClick(msg), A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$Input$onEnter(msg), attrs));
            }
    ...
    var $author$project$Color$Dark = {
        $: 'Dark'
    };
    var $author$project$Color$dark = function(hue) {
        return hue($author$project$Color$Dark);
    };
    ...
    var $mdgriffith$elm_ui$Element$padding = function(x) {
        return A2($mdgriffith$elm_ui$Internal$Model$StyleClass, $mdgriffith$elm_ui$Internal$Flag$padding, A5($mdgriffith$elm_ui$Internal$Model$PaddingStyle, 'p-' + $elm$core$String$fromInt(x), x, x, x, x));
    };
    ...
    var $author$project$Atom$horizontalDivider = A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
        $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px(1)),
        $mdgriffith$elm_ui$Element$Background$color($author$project$Color$dark($author$project$Color$grey)),
        $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
    ]), $mdgriffith$elm_ui$Element$text(' '));
    var $author$project$Color$Lighter = {
        $: 'Lighter'
    };
    var $author$project$Color$lighter = function(hue) {
        return hue($author$project$Color$Lighter);
    };
    ...
    var $mdgriffith$elm_ui$Element$spacingXY = F2(function(x, y) {
        return A2($mdgriffith$elm_ui$Internal$Model$StyleClass, $mdgriffith$elm_ui$Internal$Flag$spacing, A3($mdgriffith$elm_ui$Internal$Model$SpacingStyle, A2($mdgriffith$elm_ui$Internal$Model$spacingName, x, y), x, y));
    });
    ...
    var $author$project$Color$Light = {
        $: 'Light'
    };
    var $author$project$Color$light = function(hue) {
        return hue($author$project$Color$Light);
    };
    var $mdgriffith$elm_ui$Internal$Flag$borderStyle = $mdgriffith$elm_ui$Internal$Flag$flag(11);
    var $mdgriffith$elm_ui$Element$Border$solid = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$borderStyle, $mdgriffith$elm_ui$Internal$Style$classes.borderSolid);
    var $author$project$Contact$viewPreview = function(src) {
        return A2($mdgriffith$elm_ui$Element$image, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$px(140)),
            $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px(140)),
            $mdgriffith$elm_ui$Element$Border$solid,
            $mdgriffith$elm_ui$Element$Border$color($author$project$Color$light($author$project$Color$blue))
        ]), {
            description: '',
            src: src
        });
    ...
    var $mdgriffith$elm_ui$Element$paddingEach = function(_v0) {
        ...
        var left = _v0.left;
        return _Utils_eq(top, right) && _Utils_eq(top, bottom) && _Utils_eq(top, left) ? A2($mdgriffith$elm_ui$Internal$Model$StyleClass, $mdgriffith$elm_ui$Internal$Flag$padding, A5($mdgriffith$elm_ui$Internal$Model$PaddingStyle, 'p-' + $elm$core$String$fromInt(top), top, top, top, top)) : A2($mdgriffith$elm_ui$Internal$Model$StyleClass, $mdgriffith$elm_ui$Internal$Flag$padding, A5($mdgriffith$elm_ui$Internal$Model$PaddingStyle, A4($mdgriffith$elm_ui$Internal$Model$paddingName, top, right, bottom, left), top, right, bottom, left));
    };
        ...
        if (spaced.$ === 'Nothing') return A4($mdgriffith$elm_ui$Internal$Model$element, $mdgriffith$elm_ui$Internal$Model$asRow, $mdgriffith$elm_ui$Internal$Model$div, A2($elm$core$List$cons, $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.contentLeft + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.contentCenterY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.wrapped)))), A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink), A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink), attrs))), $mdgriffith$elm_ui$Internal$Model$Unkeyed(children));
            ...
            var newPadding = function() {
                if (padded.$ === 'Just') {
                    ...
                    var b = _v5.d;
                    var l = _v5.e;
                    return _Utils_cmp(r, x / 2 | 0) > -1 && _Utils_cmp(b, y / 2 | 0) > -1 ? $elm$core$Maybe$Just($mdgriffith$elm_ui$Element$paddingEach({
                        bottom: b - (y / 2 | 0),
                        left: l - (x / 2 | 0),
                        right: r - (x / 2 | 0),
                        top: t - (y / 2 | 0)
    ...
    var $author$project$Contact$viewContact = F2(function(device, contact) {
        var field = F2(function(labelString, fieldString) {
            var _v1 = device._class;
            if (_v1.$ === 'Phone') return A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
                ...
                A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    ...
                    $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                    $mdgriffith$elm_ui$Element$Background$color($author$project$Color$lighter($author$project$Color$blue))
            ...
            else return A2($mdgriffith$elm_ui$Element$row, _List_Nil, _List_fromArray([
                A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$px(250))
                ]), $mdgriffith$elm_ui$Element$text(labelString)),
                A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
                    $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
                ]), _List_fromArray([
        ...
        var divider = function() {
            ...
            if (_v0.$ === 'Phone') return $mdgriffith$elm_ui$Element$text('');
            else return $author$project$Atom$horizontalDivider;
        }();
        return _List_fromArray([
            divider,
            A2(field, 'お名前（漢字）', $author$project$Inquiry$Name$toString(contact.name) + '\u3000様'),
            divider,
            A2(field, 'お名前（ふりがな）', $author$project$Inquiry$Kana$toString(contact.kana)),
            divider,
            A2(field, 'メールアドレス', $author$project$Inquiry$Email$toString(contact.email)),
            divider,
            A2(field, 'お電話番号', A2($elm$core$Maybe$withDefault, '', A2($elm$core$Maybe$map, $author$project$Inquiry$Tel$toString, contact.tel))),
            divider,
            A2(field, '内容', $author$project$Inquiry$Content$toString(contact.content)),
            divider,
            A2($mdgriffith$elm_ui$Element$wrappedRow, _List_fromArray([
                $mdgriffith$elm_ui$Element$spacing(4),
                $mdgriffith$elm_ui$Element$centerX
            ]), A2($elm$core$List$map, $author$project$Contact$viewPreview, contact.images))
        ]);
    });
    ...
    var $author$project$Contact$viewConfirm = F3(function(device, contact, maybeString) {
        if (maybeString.$ === 'Just') {
            var errorString = maybeString.a;
            return _Utils_ap(_List_fromArray([
                A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    $mdgriffith$elm_ui$Element$Border$width(1),
                    $mdgriffith$elm_ui$Element$Border$color($author$project$Color$dark($author$project$Color$red)),
                    $mdgriffith$elm_ui$Element$Border$rounded(4),
                    A2($mdgriffith$elm_ui$Element$paddingXY, 4, 10),
                    $mdgriffith$elm_ui$Element$spacing(8),
                    $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                    $mdgriffith$elm_ui$Element$Font$color($author$project$Color$dark($author$project$Color$red))
                ]), A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    $mdgriffith$elm_ui$Element$centerX
                ]), $mdgriffith$elm_ui$Element$text(errorString)))
            ]), _Utils_ap(A2($author$project$Contact$viewContact, device, contact), _List_fromArray([
                A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    $mdgriffith$elm_ui$Element$centerX,
                    ...
                    $mdgriffith$elm_ui$Element$Background$color($author$project$Color$dark($author$project$Color$grey)),
                    $mdgriffith$elm_ui$Element$Border$rounded(4),
                    $mdgriffith$elm_ui$Element$Border$color($author$project$Color$dark($author$project$Color$grey)),
                    $mdgriffith$elm_ui$Element$Font$color($author$project$Color$white),
                    A2($mdgriffith$elm_ui$Element$paddingXY, 20, 10),
                    $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$px(256))
                ]), {
                    label: A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                        $mdgriffith$elm_ui$Element$centerX
                    ]), $mdgriffith$elm_ui$Element$text('再度送信')),
                    onPress: $elm$core$Maybe$Just($author$project$Contact$ClickedSend(contact))
                }))
            ])));
        } else return _Utils_ap(A2($author$project$Contact$viewContact, device, contact), _List_fromArray([
            A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                $mdgriffith$elm_ui$Element$centerX,
            ...
            A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
                ...
                A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    $mdgriffith$elm_ui$Element$centerX,
                    $mdgriffith$elm_ui$Element$padding(20),
                    $mdgriffith$elm_ui$Element$width(A2($mdgriffith$elm_ui$Element$maximum, 256, $mdgriffith$elm_ui$Element$fill))
                ]), A2($mdgriffith$elm_ui$Element$Input$button, _List_fromArray([
                    $mdgriffith$elm_ui$Element$Background$color($author$project$Color$dark($author$project$Color$grey)),
                    $mdgriffith$elm_ui$Element$Border$rounded(4),
                    $mdgriffith$elm_ui$Element$Border$color($author$project$Color$dark($author$project$Color$grey)),
                    ...
                    onPress: $elm$core$Maybe$Just($author$project$Contact$ClickedBack)
                })),
                A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    $mdgriffith$elm_ui$Element$centerX,
                    $mdgriffith$elm_ui$Element$padding(20),
                    ...
                    $mdgriffith$elm_ui$Element$Background$color($author$project$Color$base($author$project$Color$teal)),
                    $mdgriffith$elm_ui$Element$Border$rounded(4),
                    $mdgriffith$elm_ui$Element$Border$color($author$project$Color$base($author$project$Color$teal)),
                    $mdgriffith$elm_ui$Element$Font$color($author$project$Color$white),
                    A2($mdgriffith$elm_ui$Element$paddingXY, 20, 10),
                    $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
                ]), {
    ...
    var $author$project$Contact$ClickedConfirm = {
        $: 'ClickedConfirm'
    };
    ...
    var $mdgriffith$elm_ui$Element$Input$applyLabel = F3(function(attrs, label, input) {
        if (label.$ === 'HiddenLabel') {
            ...
            switch(position.$){
                ...
                case 'OnRight':
                    return A4($mdgriffith$elm_ui$Internal$Model$element, $mdgriffith$elm_ui$Internal$Model$asRow, $mdgriffith$elm_ui$Internal$Model$NodeName('label'), attrs, $mdgriffith$elm_ui$Internal$Model$Unkeyed(_List_fromArray([
                        input,
                        labelElement
                    ])));
                default:
    ...
    var $mdgriffith$elm_ui$Element$Input$onKeyLookup = function(lookup) {
        ...
        var isKey = A2($elm$json$Json$Decode$andThen, decode, A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string));
        return $mdgriffith$elm_ui$Internal$Model$Attr(A2($elm$html$Html$Events$on, 'keyup', isKey));
    };
    var $mdgriffith$elm_ui$Element$Input$space = ' ';
    var $mdgriffith$elm_ui$Element$Input$tabindex = A2($elm$core$Basics$composeL, $mdgriffith$elm_ui$Internal$Model$Attr, $elm$html$Html$Attributes$tabindex);
    var $mdgriffith$elm_ui$Element$Input$checkbox = F2(function(attrs, _v0) {
        var label = _v0.label;
        var icon = _v0.icon;
        ...
        var attributes = _Utils_ap(_List_fromArray([
            ...
            $mdgriffith$elm_ui$Internal$Model$Attr($elm$html$Html$Events$onClick(onChange(!checked))),
            $mdgriffith$elm_ui$Element$Region$announce,
            $mdgriffith$elm_ui$Element$Input$onKeyLookup(function(code) {
                return _Utils_eq(code, $mdgriffith$elm_ui$Element$Input$enter) ? $elm$core$Maybe$Just(onChange(!checked)) : _Utils_eq(code, $mdgriffith$elm_ui$Element$Input$space) ? $elm$core$Maybe$Just(onChange(!checked)) : $elm$core$Maybe$Nothing;
            }),
        ...
        return A3($mdgriffith$elm_ui$Element$Input$applyLabel, attributes, label, A4($mdgriffith$elm_ui$Internal$Model$element, $mdgriffith$elm_ui$Internal$Model$asEl, $mdgriffith$elm_ui$Internal$Model$div, _List_fromArray([
            $mdgriffith$elm_ui$Internal$Model$Attr(A2($elm$html$Html$Attributes$attribute, 'role', 'checkbox')),
            $mdgriffith$elm_ui$Internal$Model$Attr(A2($elm$html$Html$Attributes$attribute, 'aria-checked', checked ? 'true' : 'false')),
    ...
    var $mdgriffith$elm_ui$Internal$Model$Rotate = F2(function(a, b) {
        return {
            $: 'Rotate',
            a: a,
            b: b
    ...
    var $mdgriffith$elm_ui$Element$rotate = function(angle) {
        return A2($mdgriffith$elm_ui$Internal$Model$TransformComponent, $mdgriffith$elm_ui$Internal$Flag$rotate, A2($mdgriffith$elm_ui$Internal$Model$Rotate, _Utils_Tuple3(0, 0, 1), angle));
    };
    ...
    var $mdgriffith$elm_ui$Element$Border$shadow = function(almostShade) {
        ...
        return A2($mdgriffith$elm_ui$Internal$Model$StyleClass, $mdgriffith$elm_ui$Internal$Flag$shadows, A3($mdgriffith$elm_ui$Internal$Model$Single, $mdgriffith$elm_ui$Internal$Model$boxShadowName(shade), 'box-shadow', $mdgriffith$elm_ui$Internal$Model$formatBoxShadow(shade)));
    };
    ...
    var $mdgriffith$elm_ui$Element$Input$defaultCheckbox = function(checked) {
        return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            ...
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$px(14)),
            $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px(14)),
            ...
            $mdgriffith$elm_ui$Element$Border$color(checked ? A3($mdgriffith$elm_ui$Element$rgb, 59 / 255, 0.6, 252 / 255) : A3($mdgriffith$elm_ui$Element$rgb, 211 / 255, 211 / 255, 211 / 255)),
            ...
            $mdgriffith$elm_ui$Element$Background$color(checked ? A3($mdgriffith$elm_ui$Element$rgb, 59 / 255, 0.6, 252 / 255) : $mdgriffith$elm_ui$Element$Input$white),
            $mdgriffith$elm_ui$Element$Border$width(checked ? 0 : 1)
        ]), checked ? A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$Border$color($mdgriffith$elm_ui$Element$Input$white),
            $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px(6)),
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$px(9)),
            $mdgriffith$elm_ui$Element$rotate($elm$core$Basics$degrees(-45)),
            $mdgriffith$elm_ui$Element$centerX,
            $mdgriffith$elm_ui$Element$centerY,
    ...
    var $mdgriffith$elm_ui$Element$Input$Padding = F4(function(a, b, c, d) {
        return {
            $: 'Padding',
            a: a,
            b: b,
    ...
    var $mdgriffith$elm_ui$Element$alpha = function(o) {
        var transparency = function(x) {
            return 1 - x;
        }(A2($elm$core$Basics$min, 1, A2($elm$core$Basics$max, 0, o)));
    ...
    var $mdgriffith$elm_ui$Internal$Model$filter = function(attrs) {
        return A3($elm$core$List$foldr, F2(function(x, _v0) {
            var found = _v0.a;
            var has = _v0.b;
            switch(x.$){
                case 'NoAttribute':
                ...
                case 'Class':
                    var key = x.a;
                    return _Utils_Tuple2(A2($elm$core$List$cons, x, found), has);
                case 'Attr':
                    var attr = x.a;
                    return _Utils_Tuple2(A2($elm$core$List$cons, x, found), has);
                case 'StyleClass':
                ...
                case 'Width':
                    var width = x.a;
                    return A2($elm$core$Set$member, 'width', has) ? _Utils_Tuple2(found, has) : _Utils_Tuple2(A2($elm$core$List$cons, x, found), A2($elm$core$Set$insert, 'width', has));
                case 'Height':
                    var height = x.a;
                    return A2($elm$core$Set$member, 'height', has) ? _Utils_Tuple2(found, has) : _Utils_Tuple2(A2($elm$core$List$cons, x, found), A2($elm$core$Set$insert, 'height', has));
                case 'Describe':
                    var description = x.a;
                    return A2($elm$core$Set$member, 'described', has) ? _Utils_Tuple2(found, has) : _Utils_Tuple2(A2($elm$core$List$cons, x, found), A2($elm$core$Set$insert, 'described', has));
                case 'Nearby':
                    var location = x.a;
                    var elem = x.b;
                    return _Utils_Tuple2(A2($elm$core$List$cons, x, found), has);
                case 'AlignX':
                    return A2($elm$core$Set$member, 'align-x', has) ? _Utils_Tuple2(found, has) : _Utils_Tuple2(A2($elm$core$List$cons, x, found), A2($elm$core$Set$insert, 'align-x', has));
                case 'AlignY':
                    return A2($elm$core$Set$member, 'align-y', has) ? _Utils_Tuple2(found, has) : _Utils_Tuple2(A2($elm$core$List$cons, x, found), A2($elm$core$Set$insert, 'align-y', has));
                default:
                    return A2($elm$core$Set$member, 'transform', has) ? _Utils_Tuple2(found, has) : _Utils_Tuple2(A2($elm$core$List$cons, x, found), A2($elm$core$Set$insert, 'transform', has));
            }
        }), _Utils_Tuple2(_List_Nil, $elm$core$Set$empty), attrs).a;
    };
    var $mdgriffith$elm_ui$Internal$Model$get = F2(function(attrs, isAttr) {
        return A3($elm$core$List$foldr, F2(function(x, found) {
            return isAttr(x) ? A2($elm$core$List$cons, x, found) : found;
        }), _List_Nil, $mdgriffith$elm_ui$Internal$Model$filter(attrs));
    });
    ...
    var $mdgriffith$elm_ui$Element$Input$inheritablePlaceholderAttributes = function(attr) {
        _v0$3: while(true){
            if (attr.$ === 'StyleClass') switch(attr.b.$){
                case 'PaddingStyle':
                    var _v1 = attr.b;
                    return true;
                case 'BorderWidth':
    ...
    var $mdgriffith$elm_ui$Internal$Model$isContent = function(len) {
        isContent: while(true)switch(len.$){
            case 'Content':
                return true;
            case 'Max':
                var l = len.b;
    ...
    var $mdgriffith$elm_ui$Element$Input$textHeightContent = F4(function(textValue, spacing, maybePadding, maybeBorder) {
        ...
        var newlineCount = function(x) {
            return x < 1 ? 1 : x;
        }($elm$core$List$length($elm$core$String$lines(textValue)));
        var additionalSpacing = (newlineCount - 1) * spacing + A2($elm$core$Maybe$withDefault, 0, A2($elm$core$Maybe$map, topBottom, maybePadding)) + A2($elm$core$Maybe$withDefault, 0, A2($elm$core$Maybe$map, topBottom, maybeBorder));
        ...
        return A2($mdgriffith$elm_ui$Internal$Model$StyleClass, $mdgriffith$elm_ui$Internal$Flag$heightTextAreaContent, A3($mdgriffith$elm_ui$Internal$Model$Single, 'textarea-height-' + $elm$core$String$fromInt(newlineCount), 'height', heightValue(newlineCount)));
    });
    ...
    var $mdgriffith$elm_ui$Element$Input$textHelper = F3(function(textInput, attrs, textOptions) {
        ...
        var attributesFromChild = A2($mdgriffith$elm_ui$Internal$Model$get, attributes, function(attr) {
            _v21$7: while(true)switch(attr.$){
                case 'Width':
                    if (attr.a.$ === 'Fill') return true;
                    else break _v21$7;
                case 'Height':
                    if (attr.a.$ === 'Fill') return true;
                    else break _v21$7;
        ...
        var heightFillFromChild = A2($mdgriffith$elm_ui$Internal$Model$get, attributes, function(attr) {
            if (attr.$ === 'Height' && attr.a.$ === 'Fill') return true;
            else return false;
        });
        var inputPadding = A2($mdgriffith$elm_ui$Internal$Model$get, attributes, function(attr) {
            if (attr.$ === 'StyleClass' && attr.b.$ === 'PaddingStyle') {
                var _v19 = attr.b;
                return true;
            } else return false;
        });
        var nearbys = A2($mdgriffith$elm_ui$Internal$Model$get, attributes, function(attr) {
            if (attr.$ === 'Nearby') return true;
            else return false;
        });
        var noNearbys = A2($elm$core$List$filter, A2($elm$core$Basics$composeL, $elm$core$Basics$not, forNearby), attributes);
        var _v0 = function() {
            var _v1 = textInput.type_;
            if (_v1.$ === 'TextInputNode') {
                var inputType = _v1.a;
                return _Utils_Tuple3('input', _Utils_ap(_List_fromArray([
                    ...
                    function() {
                        ...
                        if (_v2.$ === 'Nothing') return $mdgriffith$elm_ui$Internal$Model$NoAttribute;
                        else {
                            var fill = _v2.a;
                ...
                var _v3 = A3($elm$core$List$foldr, F2(function(attr, found) {
                    _v4$5: while(true)switch(attr.$){
                        case 'Describe':
                            return found;
                        case 'Height':
                            var len = attr.a;
                            var _v5 = found.heightContent;
                            if (_v5.$ === 'Nothing') return _Utils_update(found, {
                                adjustedAttributes: A2($elm$core$List$cons, attr, found.adjustedAttributes),
                                heightContent: $elm$core$Maybe$Just($mdgriffith$elm_ui$Internal$Model$isContent(len))
                            });
                            else return found;
                        case 'StyleClass':
                            switch(attr.b.$){
                                case 'BorderWidth':
                                    ...
                                    if (_v7.$ === 'Nothing') return _Utils_update(found, {
                                        adjustedAttributes: A2($elm$core$List$cons, attr, found.adjustedAttributes),
                                        maybeBorder: $elm$core$Maybe$Just(A4($mdgriffith$elm_ui$Element$Input$Padding, t, r, b, l))
                                    });
                                    else return found;
                                case 'PaddingStyle':
                                    var _v8 = attr.b;
                                    ...
                                    if (_v9.$ === 'Nothing') return _Utils_update(found, {
                                        adjustedAttributes: found.adjustedAttributes,
                                        maybePadding: $elm$core$Maybe$Just(A4($mdgriffith$elm_ui$Element$Input$Padding, t, r, b, l))
                                    });
                                    else return found;
                                case 'SpacingStyle':
                                    var _v10 = attr.b;
                                    ...
                                    if (_v11.$ === 'Nothing') return _Utils_update(found, {
                                        adjustedAttributes: A2($elm$core$List$cons, attr, found.adjustedAttributes),
                    ...
                    adjustedAttributes: _List_Nil,
                    heightContent: $elm$core$Maybe$Nothing,
                    maybeBorder: $elm$core$Maybe$Nothing,
                    maybePadding: $elm$core$Maybe$Nothing,
                    maybeSpacing: $elm$core$Maybe$Nothing
                }, attributes);
                ...
                return _Utils_Tuple3('textarea', _Utils_ap(_List_fromArray([
                    $mdgriffith$elm_ui$Element$Input$spellcheck(textInput.spellchecked),
                    ...
                    function() {
                        if (maybePadding.$ === 'Nothing') return $mdgriffith$elm_ui$Internal$Model$NoAttribute;
                        else {
                    ...
                    function() {
                        if (heightContent.$ === 'Nothing') return $mdgriffith$elm_ui$Internal$Model$NoAttribute;
                        else {
                            if (heightContent.a) return A4($mdgriffith$elm_ui$Element$Input$textHeightContent, textOptions.text, spacing, maybePadding, maybeBorder);
                            else return $mdgriffith$elm_ui$Internal$Model$NoAttribute;
                        }
                    }()
                ]), adjustedAttributes), _List_fromArray([
                    $mdgriffith$elm_ui$Internal$Model$unstyled($elm$html$Html$text(textOptions.text))
                ]));
            }
        }();
        var inputNode = _v0.a;
        ...
        var inputElement = A4($mdgriffith$elm_ui$Internal$Model$element, $mdgriffith$elm_ui$Internal$Model$asEl, $mdgriffith$elm_ui$Internal$Model$div, A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill), $elm$core$List$concat(_List_fromArray([
            nearbys,
            heightFillFromChild,
            function() {
                var _v15 = textOptions.placeholder;
                if (_v15.$ === 'Nothing') return _List_Nil;
                else {
                    var _v16 = _v15.a;
                    var placeholderAttrs = _v16.a;
                    var placeholderEl = _v16.b;
                    return _List_fromArray([
                        $mdgriffith$elm_ui$Element$inFront(A2($mdgriffith$elm_ui$Element$el, A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$Input$defaultTextPadding, _Utils_ap(forPlaceholder, _Utils_ap(_List_fromArray([
                            ...
                            $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
                            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                            $mdgriffith$elm_ui$Element$alpha(textOptions.text === '' ? 1 : 0)
                        ]), placeholderAttrs))), placeholderEl))
                    ]);
                }
            }()
        ]))), $mdgriffith$elm_ui$Internal$Model$Unkeyed(_List_fromArray([
            A4($mdgriffith$elm_ui$Internal$Model$element, $mdgriffith$elm_ui$Internal$Model$asEl, $mdgriffith$elm_ui$Internal$Model$NodeName(inputNode), $elm$core$List$concat(_List_fromArray([
                _List_fromArray([
        ...
        return A3($mdgriffith$elm_ui$Element$Input$applyLabel, A2($elm$core$List$cons, A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.cursorText), A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$Input$isHiddenLabel(textOptions.label) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : $mdgriffith$elm_ui$Element$spacing(5), A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$Region$announce, attributesFromChild))), textOptions.label, inputElement);
    });
    ...
    var $author$project$Contact$errorField = function(maybeString) {
        if (maybeString.$ === 'Just') return _List_fromArray([
            $mdgriffith$elm_ui$Element$Border$color($author$project$Color$base($author$project$Color$red))
        ]);
        else return _List_fromArray([
            $mdgriffith$elm_ui$Element$Border$color($author$project$Color$dark($author$project$Color$grey))
        ]);
    ...
    var $author$project$Error$errorField = function(error) {
        if (error.$ === 'Required') return '入力をお願いします';
        else {
            var s = error.a;
            return s;
        }
    };
    var $mdgriffith$elm_ui$Internal$Model$Min = F2(function(a, b) {
        return {
            $: 'Min',
            a: a,
            b: b
    ...
    var $mdgriffith$elm_ui$Element$minimum = F2(function(i, l) {
        return A2($mdgriffith$elm_ui$Internal$Model$Min, i, l);
    });
    var $author$project$Contact$errorTip = F2(function(maybeString, device) {
        var err = A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$Font$color($author$project$Color$base($author$project$Color$red)),
            $mdgriffith$elm_ui$Element$Font$size($author$project$Atom$Font$sm),
            $mdgriffith$elm_ui$Element$height(A2($mdgriffith$elm_ui$Element$minimum, 16, $mdgriffith$elm_ui$Element$fill))
        ]), $mdgriffith$elm_ui$Element$text(A2($elm$core$Maybe$withDefault, '', maybeString)));
        var _v0 = device._class;
        if (_v0.$ === 'Phone') return err;
        else return A2($mdgriffith$elm_ui$Element$row, _List_Nil, _List_fromArray([
            A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$px(250))
    ...
    var $author$project$Contact$labelAttrs = function(device) {
        var _v0 = device._class;
        if (_v0.$ === 'Phone') return _List_fromArray([
    ...
    var $mdgriffith$elm_ui$Element$Input$Above = {
        $: 'Above'
    };
    ...
    var $author$project$Contact$labelTag = F2(function(bgColor, tag) {
        return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$Font$size($author$project$Atom$Font$sm),
            $mdgriffith$elm_ui$Element$Font$color($author$project$Color$white),
    ...
    var $author$project$Contact$labelBase = F2(function(_v0, device) {
        var labelString = _v0.labelString;
        var bgColor = _v0.bgColor;
        var tag = _v0.tag;
        var row_ = A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
        ...
        var _v1 = device._class;
        if (_v1.$ === 'Phone') return A2($mdgriffith$elm_ui$Element$Input$labelAbove, $author$project$Contact$labelAttrs(device), row_);
        else return A2($mdgriffith$elm_ui$Element$Input$labelLeft, $author$project$Contact$labelAttrs(device), row_);
    });
    var $author$project$Contact$labelOptional = function(l) {
        return $author$project$Contact$labelBase({
            bgColor: $author$project$Color$light($author$project$Color$teal),
            labelString: l,
            tag: '任意'
        });
    };
    var $author$project$Contact$labelRequired = function(l) {
        return $author$project$Contact$labelBase({
            bgColor: $author$project$Color$light($author$project$Color$red),
            labelString: l,
            tag: '必須'
        });
    };
    var $mdgriffith$elm_ui$Element$Input$OnRight = {
        $: 'OnRight'
    };
    ...
    var $mdgriffith$elm_ui$Element$Input$multiline = F2(function(attrs, multi) {
        return A3($mdgriffith$elm_ui$Element$Input$textHelper, {
            autofill: $elm$core$Maybe$Nothing,
            spellchecked: multi.spellcheck,
            type_: $mdgriffith$elm_ui$Element$Input$TextArea
        }, attrs, {
            label: multi.label,
    ...
    var $mdgriffith$elm_ui$Element$newTabLink = F2(function(attrs, _v0) {
        var url = _v0.url;
        var label = _v0.label;
        return A4($mdgriffith$elm_ui$Internal$Model$element, $mdgriffith$elm_ui$Internal$Model$asEl, $mdgriffith$elm_ui$Internal$Model$NodeName('a'), A2($elm$core$List$cons, $mdgriffith$elm_ui$Internal$Model$Attr($elm$html$Html$Attributes$href(url)), A2($elm$core$List$cons, $mdgriffith$elm_ui$Internal$Model$Attr($elm$html$Html$Attributes$rel('noopener noreferrer')), A2($elm$core$List$cons, $mdgriffith$elm_ui$Internal$Model$Attr($elm$html$Html$Attributes$target('_blank')), A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink), A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink), A2($elm$core$List$cons, $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.contentCenterX + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.contentCenterY)), attrs)))))), $mdgriffith$elm_ui$Internal$Model$Unkeyed(_List_fromArray([
            label
        ])));
    });
    ...
    var $author$project$Contact$DragEnter = {
        $: 'DragEnter'
    };
    var $author$project$Contact$DragLeave = {
        $: 'DragLeave'
    };
    var $author$project$Contact$Pick = {
        $: 'Pick'
    };
    ...
    var $elm$json$Json$Decode$oneOrMoreHelp = F2(function(toValue, xs) {
        if (!xs.b) return $elm$json$Json$Decode$fail('a ARRAY with at least ONE element');
        else {
            var y = xs.a;
            var ys = xs.b;
            return $elm$json$Json$Decode$succeed(A2(toValue, y, ys));
        }
    });
    var $elm$json$Json$Decode$oneOrMore = F2(function(toValue, decoder) {
        return A2($elm$json$Json$Decode$andThen, $elm$json$Json$Decode$oneOrMoreHelp(toValue), $elm$json$Json$Decode$list(decoder));
    });
    var $author$project$Contact$dropDecoder = A2($elm$json$Json$Decode$at, _List_fromArray([
        'dataTransfer',
        'files'
    ...
    var $author$project$Contact$hijackOn = F2(function(e, d) {
        return A2($elm$html$Html$Events$preventDefaultOn, e, A2($elm$json$Json$Decode$map, $author$project$Contact$hijack, d));
    });
    ...
    var $mdgriffith$elm_ui$Element$scale = function(n) {
        return A2($mdgriffith$elm_ui$Internal$Model$TransformComponent, $mdgriffith$elm_ui$Internal$Flag$scale, $mdgriffith$elm_ui$Internal$Model$Scale(_Utils_Tuple3(n, n, 1)));
    };
    ...
    var $elm$svg$Svg$Attributes$from = function(value) {
        return A2(_VirtualDom_attribute, 'from', _VirtualDom_noJavaScriptUri(value));
    };
    ...
    var $elm$svg$Svg$Attributes$to = function(value) {
        return A2(_VirtualDom_attribute, 'to', _VirtualDom_noJavaScriptUri(value));
    };
    ...
    var $author$project$Icon$loading = function(size) {
        return A2($elm$svg$Svg$svg, _List_fromArray([
            $elm$svg$Svg$Attributes$version('1.1'),
            $elm$svg$Svg$Attributes$id('loader-1'),
            $elm$svg$Svg$Attributes$x('0px'),
            $elm$svg$Svg$Attributes$y('0px'),
            $elm$svg$Svg$Attributes$width($elm$core$String$fromInt(size) + 'px'),
            $elm$svg$Svg$Attributes$height($elm$core$String$fromInt(size) + 'px'),
            ...
            A2($elm$svg$Svg$path, _List_fromArray([
                ...
                A2($elm$svg$Svg$animateTransform, _List_fromArray([
    ...
    var $author$project$Contact$viewPreviewFile = F3(function(device, index, src) {
        if (src === '') return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$px($author$project$Contact$imageSize)),
            $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px($author$project$Contact$imageSize)),
            $mdgriffith$elm_ui$Element$Border$solid,
            $mdgriffith$elm_ui$Element$Border$width(1)
        ]), A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
            $mdgriffith$elm_ui$Element$centerX,
            $mdgriffith$elm_ui$Element$centerY
        ]), $mdgriffith$elm_ui$Element$html($author$project$Icon$loading(100))));
        else {
            var imageCell = function(w) {
                return $mdgriffith$elm_ui$Element$html(A2($elm$html$Html$div, _List_fromArray([
                    ...
                    A2($elm$html$Html$img, _List_fromArray([
                        ...
                        $elm$html$Html$Events$onClick($author$project$Contact$Enlarge(index))
                    ]), _List_Nil)
                ])));
            };
            var _v0 = device._class;
            if (_v0.$ === 'Phone') return imageCell('w-1/2');
            else return imageCell('w-1/5');
        }
    });
    ...
    var $author$project$Contact$viewUpload = F2(function(device, model) {
        var uploadButton = function(l) {
            return A2($mdgriffith$elm_ui$Element$Input$button, _List_fromArray([
                $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$px(256)),
                $mdgriffith$elm_ui$Element$Border$color($author$project$Color$base($author$project$Color$teal)),
                ...
                onPress: $elm$core$Maybe$Just($author$project$Contact$Pick)
            });
        };
        var dropStyles = model.hover ? _List_fromArray([
            $mdgriffith$elm_ui$Element$Border$color($author$project$Color$dark($author$project$Color$yellow)),
            $mdgriffith$elm_ui$Element$Background$color($author$project$Color$lighter($author$project$Color$yellow)),
            $mdgriffith$elm_ui$Element$scale(1.05)
        ]) : _List_fromArray([
            $mdgriffith$elm_ui$Element$Border$color($author$project$Color$dark($author$project$Color$grey))
        ]);
        if (_Utils_eq(model.form.images, _List_Nil)) {
            var _v0 = device._class;
            if (_v0.$ === 'Phone') return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                $mdgriffith$elm_ui$Element$centerX
            ]), uploadButton('画像のアップロード'));
            else return A2($mdgriffith$elm_ui$Element$el, _Utils_ap(_List_fromArray([
                $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px(256)),
                $mdgriffith$elm_ui$Element$Border$dashed,
                $mdgriffith$elm_ui$Element$Border$width(2),
                $mdgriffith$elm_ui$Element$spacing(10),
                $mdgriffith$elm_ui$Element$centerX,
                $mdgriffith$elm_ui$Element$centerY,
                $mdgriffith$elm_ui$Element$htmlAttribute(A2($author$project$Contact$hijackOn, 'dragenter', $elm$json$Json$Decode$succeed($author$project$Contact$DragEnter))),
                $mdgriffith$elm_ui$Element$htmlAttribute(A2($author$project$Contact$hijackOn, 'dragover', $elm$json$Json$Decode$succeed($author$project$Contact$DragEnter))),
                $mdgriffith$elm_ui$Element$htmlAttribute(A2($author$project$Contact$hijackOn, 'dragleave', $elm$json$Json$Decode$succeed($author$project$Contact$DragLeave))),
                $mdgriffith$elm_ui$Element$htmlAttribute(A2($author$project$Contact$hijackOn, 'drop', $author$project$Contact$dropDecoder))
            ]), dropStyles), A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
        ...
        } else return A2($mdgriffith$elm_ui$Element$wrappedRow, _List_fromArray([
            $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
        ]), function() {
            if ($elm$core$List$length(model.form.images) >= 10) return A2($elm$core$List$indexedMap, $author$project$Contact$viewPreviewFile(device), model.form.images);
            else {
                var restLabel = '残り' + ($elm$core$String$fromInt(10 - $elm$core$List$length(model.form.images)) + '枚登録可能');
                var uploader = function() {
                    var _v1 = device._class;
                    if (_v1.$ === 'Phone') return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                        $mdgriffith$elm_ui$Element$centerX
                    ...
                    ]), dropStyles), A2($mdgriffith$elm_ui$Element$Input$button, _List_fromArray([
                        $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                        $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px(160)),
                        $mdgriffith$elm_ui$Element$Border$dashed,
                        $mdgriffith$elm_ui$Element$Border$color($author$project$Color$dark($author$project$Color$grey)),
                        $mdgriffith$elm_ui$Element$Border$width(2),
                        $mdgriffith$elm_ui$Element$mouseOver(_List_fromArray([
                        ...
                        label: A2($mdgriffith$elm_ui$Element$column, _List_fromArray([
                            $mdgriffith$elm_ui$Element$centerX,
                            $mdgriffith$elm_ui$Element$Font$size($author$project$Atom$Font$base)
                        ]), _List_fromArray([
                ...
                return _Utils_ap(A2($elm$core$List$indexedMap, $author$project$Contact$viewPreviewFile(device), model.form.images), _List_fromArray([
                    uploader
                ]));
            }
        }());
    });
    var $author$project$Contact$viewForm = F2(function(device, model) {
        var form = model.form;
        var submitted = model.submitted;
        var hasError = function(cond) {
            var _v1 = A2($arowM$elm_form_decoder$Form$Decoder$run, $author$project$Contact$decoder, form);
            if (_v1.$ === 'Ok') return _List_Nil;
            else {
                var errs = _v1.a;
                return A2($elm$core$List$filter, cond, errs);
            }
        };
        var fieldError = F2(function(errorToString, d) {
            var _v0 = A2($arowM$elm_form_decoder$Form$Decoder$run, d, form);
            if (_v0.$ === 'Ok') return $elm$core$Maybe$Nothing;
            else {
                var errs = _v0.a;
                return submitted ? $elm$core$Maybe$Just($elm$core$String$concat(A2($elm$core$List$map, errorToString, errs))) : $elm$core$Maybe$Nothing;
            }
        });
        return _List_fromArray([
            A2($mdgriffith$elm_ui$Element$el, _List_Nil, $mdgriffith$elm_ui$Element$text('送信にあたっての注意')),
            ...
            A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
                ...
                A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                    $mdgriffith$elm_ui$Element$Font$color($author$project$Color$dark($author$project$Color$teal)),
                    A2($mdgriffith$elm_ui$Element$paddingXY, 10, 0)
                ]), $mdgriffith$elm_ui$Element$text('info@officeiko.co.jp')),
                $mdgriffith$elm_ui$Element$text('を迷惑メールフィルタから除外してください。')
            ])),
            A2($mdgriffith$elm_ui$Element$el, _List_Nil, $mdgriffith$elm_ui$Element$text('お問い合わせ入力欄')),
            $author$project$Atom$horizontalDividerGradient({
                angle: 90,
                steps: _List_fromArray([
                    $author$project$Color$base($author$project$Color$red),
            ...
            A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
                ...
                A2($author$project$Contact$labelTag, $author$project$Color$light($author$project$Color$red), '必須'),
                $mdgriffith$elm_ui$Element$text('のついた項目は必ずご入力してください。')
            ])),
            $author$project$Atom$horizontalDivider,
            A2($mdgriffith$elm_ui$Element$column, $author$project$Contact$decoInputField, _List_fromArray([
                A2($mdgriffith$elm_ui$Element$Input$text, $elm$core$List$concat(_List_fromArray([
                    $author$project$Contact$errorField(A2(fieldError, $author$project$Error$errorField, $author$project$Contact$decoderName)),
                    _List_fromArray([
                        $mdgriffith$elm_ui$Element$Border$rounded(0),
                        $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fillPortion(2))
                    ])
                ])), {
                    label: A2($author$project$Contact$labelRequired, 'お名前（漢字）', device),
                    onChange: $author$project$Contact$ChangedName,
                    placeholder: $elm$core$Maybe$Just(A2($mdgriffith$elm_ui$Element$Input$placeholder, _List_Nil, $mdgriffith$elm_ui$Element$text('田中\u3000太郎'))),
                    text: form.name
                }),
                A2($author$project$Contact$errorTip, A2(fieldError, $author$project$Error$errorField, $author$project$Contact$decoderName), device)
            ])),
            $author$project$Atom$horizontalDivider,
            A2($mdgriffith$elm_ui$Element$column, $author$project$Contact$decoInputField, _List_fromArray([
                A2($mdgriffith$elm_ui$Element$Input$text, $elm$core$List$concat(_List_fromArray([
                    $author$project$Contact$errorField(A2(fieldError, $author$project$Error$errorField, $author$project$Contact$decoderKana)),
                    _List_fromArray([
                        $mdgriffith$elm_ui$Element$Border$rounded(4)
                    ])
                ])), {
                    label: A2($author$project$Contact$labelRequired, 'お名前（ふりがな）', device),
                    onChange: $author$project$Contact$ChangedKana,
                    placeholder: $elm$core$Maybe$Just(A2($mdgriffith$elm_ui$Element$Input$placeholder, _List_Nil, $mdgriffith$elm_ui$Element$text('たなか\u3000たろう'))),
                    text: form.kana
                }),
                A2($author$project$Contact$errorTip, A2(fieldError, $author$project$Error$errorField, $author$project$Contact$decoderKana), device)
            ])),
            $author$project$Atom$horizontalDivider,
            A2($mdgriffith$elm_ui$Element$column, $author$project$Contact$decoInputField, _List_fromArray([
                A2($mdgriffith$elm_ui$Element$Input$text, $elm$core$List$concat(_List_fromArray([
                    $author$project$Contact$errorField(A2(fieldError, $author$project$Error$errorField, $author$project$Contact$decoderTel)),
                    _List_fromArray([
                        $mdgriffith$elm_ui$Element$Border$rounded(4)
                    ])
                ])), {
                    label: A2($author$project$Contact$labelOptional, '電話番号', device),
                    onChange: $author$project$Contact$ChangedTel,
                    placeholder: $elm$core$Maybe$Just(A2($mdgriffith$elm_ui$Element$Input$placeholder, _List_Nil, $mdgriffith$elm_ui$Element$text('090-1234-5678'))),
                    text: form.tel
                }),
                A2($author$project$Contact$errorTip, A2(fieldError, $author$project$Error$errorField, $author$project$Contact$decoderTel), device)
            ])),
            $author$project$Atom$horizontalDivider,
            A2($mdgriffith$elm_ui$Element$column, $author$project$Contact$decoInputField, _List_fromArray([
                A2($mdgriffith$elm_ui$Element$Input$email, $elm$core$List$concat(_List_fromArray([
                    $author$project$Contact$errorField(A2(fieldError, $author$project$Error$errorField, $author$project$Contact$decoderEmail)),
                    _List_fromArray([
                        $mdgriffith$elm_ui$Element$Border$rounded(4)
                    ])
                ])), {
                    label: A2($author$project$Contact$labelRequired, 'メールアドレス', device),
                    onChange: $author$project$Contact$ChangedEmail,
                    placeholder: $elm$core$Maybe$Just(A2($mdgriffith$elm_ui$Element$Input$placeholder, _List_Nil, $mdgriffith$elm_ui$Element$text('tanaka@gmail.com'))),
                    text: form.email
                }),
                A2($author$project$Contact$errorTip, A2(fieldError, $author$project$Error$errorField, $author$project$Contact$decoderEmail), device)
            ])),
            $author$project$Atom$horizontalDivider,
            A2($mdgriffith$elm_ui$Element$column, $author$project$Contact$decoInputField, _List_fromArray([
                A2($mdgriffith$elm_ui$Element$Input$multiline, $elm$core$List$concat(_List_fromArray([
                    $author$project$Contact$errorField(A2(fieldError, $author$project$Error$errorField, $author$project$Contact$decoderContent)),
                    _List_fromArray([
                        $mdgriffith$elm_ui$Element$Border$rounded(4),
                        $mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$px(200))
                    ])
                ])), {
                    label: A2($author$project$Contact$labelRequired, '内容', device),
                    onChange: $author$project$Contact$ChangedContent,
                    placeholder: $elm$core$Maybe$Nothing,
                    spellcheck: false,
                    text: form.content
                }),
                A2($author$project$Contact$errorTip, A2(fieldError, $author$project$Error$errorField, $author$project$Contact$decoderContent), device)
            ])),
            $author$project$Atom$horizontalDivider,
            A2($mdgriffith$elm_ui$Element$column, $author$project$Contact$labelAttrs(device), _List_fromArray([
                A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
                    $mdgriffith$elm_ui$Element$Font$size($author$project$Atom$Font$base),
                    A2($mdgriffith$elm_ui$Element$spacingXY, 4, 0),
                    $mdgriffith$elm_ui$Element$centerY,
                    ...
                    A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                        $mdgriffith$elm_ui$Element$alignRight
                    ]), A2($author$project$Contact$labelTag, $author$project$Color$light($author$project$Color$teal), '任意'))
                ])),
                A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
                    $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                    $mdgriffith$elm_ui$Element$Font$size($author$project$Atom$Font$sm),
                    $mdgriffith$elm_ui$Element$Font$color($author$project$Color$dark($author$project$Color$grey))
                ]), _List_fromArray([
            ...
            $author$project$Atom$horizontalDivider,
            A2($mdgriffith$elm_ui$Element$el, _List_Nil, $mdgriffith$elm_ui$Element$text('個人情報のお取り扱いについて')),
            $author$project$Atom$horizontalDividerGradient({
                angle: 90,
                steps: _List_fromArray([
                    $author$project$Color$base($author$project$Color$red),
            ...
            A2($mdgriffith$elm_ui$Element$paragraph, _List_fromArray([
                ...
                A2($mdgriffith$elm_ui$Element$newTabLink, _List_fromArray([
                    $mdgriffith$elm_ui$Element$Font$color($author$project$Color$light($author$project$Color$red))
                ]), {
                    label: $mdgriffith$elm_ui$Element$text('プライバシーポリシー'),
                    url: '/privacy'
                }),
                $mdgriffith$elm_ui$Element$text('をご確認いただき、同意いただいた上でご送信ください。ご入力いただいた情報は暗号化されて送信されます。')
            ])),
            A2($mdgriffith$elm_ui$Element$column, $author$project$Contact$decoInputField, _List_fromArray([
                A2($mdgriffith$elm_ui$Element$Input$checkbox, _List_fromArray([
                    $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
                    $mdgriffith$elm_ui$Element$centerX
                ]), {
                    checked: form.agreement,
                    icon: $mdgriffith$elm_ui$Element$Input$defaultCheckbox,
                    label: A2($mdgriffith$elm_ui$Element$Input$labelRight, _List_Nil, A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                        $mdgriffith$elm_ui$Element$Font$size($author$project$Atom$Font$base)
                    ]), $mdgriffith$elm_ui$Element$text('プライバシーポリシーに同意する'))),
                    onChange: $author$project$Contact$ClickedAgreement
                }),
                A2($author$project$Contact$errorTip, form.agreement ? $elm$core$Maybe$Nothing : !submitted ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just('プラバシーポリシーへの同意が認められておりません。'), device)
            ])),
            A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                $mdgriffith$elm_ui$Element$centerX,
                $mdgriffith$elm_ui$Element$padding(20)
                ...
                onPress: $elm$core$Maybe$Just($author$project$Contact$ClickedConfirm)
            }))
        ]);
    });
    ...
    var $author$project$Icon$close = A2($elm$svg$Svg$svg, _List_fromArray([
    ...
    var $author$project$Contact$viewOverlay = F2(function(msg, src) {
        return $mdgriffith$elm_ui$Element$html(A2($elm$html$Html$div, _List_fromArray([
            $elm$html$Html$Attributes$class('fixed inset-0 z-50 overflow-auto bg-smoke-400 flex'),
            A2($elm$html$Html$Events$stopPropagationOn, 'click', A2($elm$json$Json$Decode$map, $author$project$Contact$alwaysStopPropagate, $elm$json$Json$Decode$succeed($author$project$Contact$ClickedCloseModal)))
        ]), _List_fromArray([
            A2($elm$html$Html$div, _List_fromArray([
                $elm$html$Html$Attributes$class('relative p-8 bg-white w-full max-w-md m-auto flex-col flex'),
                A2($elm$html$Html$Events$stopPropagationOn, 'click', A2($elm$json$Json$Decode$map, $author$project$Contact$alwaysStopPropagate, $elm$json$Json$Decode$succeed($author$project$Contact$NoOp)))
            ]), _List_fromArray([
                A2($elm$html$Html$img, _List_fromArray([
                    $elm$html$Html$Attributes$src(src),
    ...
    var $author$project$Contact$ClickedResend = {
        $: 'ClickedResend'
    };
    var $author$project$Contact$viewSent = function(response) {
        return _List_fromArray([
            A2($mdgriffith$elm_ui$Element$el, _List_Nil, $mdgriffith$elm_ui$Element$text('お問い合わせありがとうございました')),
            A2($mdgriffith$elm_ui$Element$el, _List_Nil, $mdgriffith$elm_ui$Element$text('受信日時：' + response.received)),
            ...
            A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                ...
                onPress: $elm$core$Maybe$Just($author$project$Contact$ClickedResend)
            }))
        ]);
    };
    var $author$project$Color$black = A3($mdgriffith$elm_ui$Element$rgb255, 34, 41, 47);
    var $author$project$Color$Darkest = {
        $: 'Darkest'
    };
    var $author$project$Color$darkest = function(hue) {
        return hue($author$project$Color$Darkest);
    };
    ...
    var $author$project$Contact$viewTop = function(state) {
        var menu = F3(function(m1, m2, m3) {
            return A2($mdgriffith$elm_ui$Element$row, _List_fromArray([
                $mdgriffith$elm_ui$Element$spacing(16),
                $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
            ]), _List_fromArray([
                A2($mdgriffith$elm_ui$Element$el, m1, $mdgriffith$elm_ui$Element$text('1.入力')),
                A2($mdgriffith$elm_ui$Element$el, m2, $mdgriffith$elm_ui$Element$text('2.確認')),
                A2($mdgriffith$elm_ui$Element$el, m3, $mdgriffith$elm_ui$Element$text('3.完了'))
            ]));
        });
        var header = function(s) {
            return A2($mdgriffith$elm_ui$Element$el, _List_fromArray([
                $mdgriffith$elm_ui$Element$Font$color($author$project$Color$darkest($author$project$Color$grey)),
        ...
        var inactive = _Utils_ap(_List_fromArray([
            $mdgriffith$elm_ui$Element$Font$color($author$project$Color$black),
            $mdgriffith$elm_ui$Element$Background$color($author$project$Color$lighter($author$project$Color$grey))
        ]), base);
        var active = _Utils_ap(_List_fromArray([
            $mdgriffith$elm_ui$Element$Font$color($author$project$Color$white),
            $mdgriffith$elm_ui$Element$Background$color($author$project$Color$dark($author$project$Color$blue))
        ]), base);
        switch(state.$){
            case 'Editting':
                return _List_fromArray([
            ...
            case 'Confirming':
                var contact = state.a;
                var stringMaybe = state.b;
                return _List_fromArray([
                    header('お問い合わせ内容確認'),
                    A3(menu, inactive, active, inactive)
                ]);
            default:
                var response = state.a;
                return _List_fromArray([
                    header('送信完了'),
    ...
    var $author$project$Contact$view = F2(function(device, model) {
        var attrs = function() {
            var _v3 = device._class;
            if (_v3.$ === 'Phone') return _List_fromArray([
                $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
                $mdgriffith$elm_ui$Element$centerX,
                $mdgriffith$elm_ui$Element$spacing(16)
            ]);
            else return _List_fromArray([
                $mdgriffith$elm_ui$Element$width(A2($mdgriffith$elm_ui$Element$maximum, 800, $mdgriffith$elm_ui$Element$fill)),
                $mdgriffith$elm_ui$Element$centerX,
                A2($mdgriffith$elm_ui$Element$paddingXY, 40, 20),
                $mdgriffith$elm_ui$Element$spacing(20)
            ]);
        }();
        return A2($mdgriffith$elm_ui$Element$column, attrs, _Utils_ap($author$project$Contact$viewTop(model.pageState), function() {
            ...
            switch(_v0.$){
                case 'Editting':
                    ...
                    if (_v1.$ === 'Just') {
                        ...
                        var image = _v2.b;
                        return _Utils_ap(_List_fromArray([
                            A2($author$project$Contact$viewOverlay, $author$project$Contact$Remove(index), image)
                        ]), A2($author$project$Contact$viewForm, device, model));
                    } else return A2($author$project$Contact$viewForm, device, model);
                case 'Confirming':
                    var contact = _v0.a;
                    var err = _v0.b;
                    return model.sending ? _List_fromArray([
                        $author$project$Contact$viewLoading('')
                    ]) : A3($author$project$Contact$viewConfirm, device, contact, err);
                default:
                    var response = _v0.a;
                    return $author$project$Contact$viewSent(response);
            }
        }()));
    });
    var $author$project$Main$view = function(model) {
        return A2($mdgriffith$elm_ui$Element$layout, _List_Nil, A2($mdgriffith$elm_ui$Element$map, $author$project$Main$ContactMsg, A2($author$project$Contact$view, model.device, model.contact)));
    };
    ...
    _Platform_export({
        'Main': {
            'init': $author$project$Main$main(A2($elm$json$Json$Decode$andThen, function(width) {
                ...
                "types": {
                    ...
                    "aliases": {
                        ...
                        "Contact.Contact": {
                            "args": [],
                            "type": "{ name : Inquiry.Name.Name, kana : Inquiry.Kana.Kana, email : Inquiry.Email.Email, tel : Maybe.Maybe Inquiry.Tel.Tel, content : Inquiry.Content.Content, images : List.List String.String }"
                        },
                        "Inquiry.Email.Email": {
                            "args": [],
                            "type": "Email.Email"
                        ...
                        "Contact.Response": {
                            "args": [],
                            "type": "{ received : String.String, messageId : String.String }"
                        }
                    },
                    "unions": {
                        "Main.Msg": {
                        ...
                        "Contact.Msg": {
                            ...
                            "tags": {
                                ...
                                "SentMail": [
                                    "Contact.Contact",
                                    "Result.Result Http.Error Contact.Response"
                                ],
                                "Pick": [],
                                "DragEnter": [],
                                "DragLeave": [],
...
},{}],"amQqY":[function(require,module,exports) {
!function(e, t) {
    ...
    function a(e) {
        ...
        }, i = t.onElement, n = t.withCallback, s = t.avoidDuplicate, l = void 0 === s || s, a = t.once, h = void 0 !== a && a, d = t.useCapture, c = void 0 !== d && d, u = arguments.length > 2 ? arguments[2] : void 0, g = i || [];
        function v(e) {
    ...
    function B(e) {
        ...
        var t, i, n, s = y(), l = s.width, o = s.height, r = !1, a = null, g = null, f = null, p = !1, m = 1, x = 1, b = !1, S = !1, w = null, T = null, C = null, k = null, E = 0, A = 0, L = !1, I = !1, O = {
        }, P = {
    ...
    var $ = function() {
        ...
        function e() {
            ...
            t(this, e), this.customOptions = i, this.settings = l(ee, i), this.effectsClasses = this.getAnimationClasses(), this.videoPlayers = {
        ...
        return n(e, [
            ...
            },
            {
                ...
                value: function() {
                    ...
                    var i = new U(e, this, t), n = i.getConfig(), s = l({
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    e && e.length && o(e, function(e, n) {
                        var s = new U(e, t, n), o = s.getConfig(), r = l({
                        }, o);
            ...
            },
            {
                ...
                value: function() {
                    ...
                    this.elements = this.elements ? this.elements : [], !I(this.settings.elements) && E(this.settings.elements) && this.settings.elements.length && o(this.settings.elements, function(i, n) {
                        var s = new U(i, e, n), o = s.getConfig(), r = l({
                        }, o);
            ...
            },
            {
                ...
                value: function() {
                    ...
                    }, h(this.modal, "glightbox-" + this.settings.skin), this.settings.closeButton && g && (this.events.close = a("click", {
                        onElement: g,
                        withCallback: function(t, i) {
                    ...
                    if ((e = e || this.activeSlide) && !c(e, "zoomed")) {
                        ...
                        if (l <= 768 ? h(document.body, "glightbox-mobile") : d(document.body, "glightbox-mobile"), i || n) {
                            ...
                            if (i) {
                                ...
                                var m = g.split(":"), x = this.settings.videosWidth, b = this.settings.videosWidth, S = (b = z(x) || -1 !== x.indexOf("px") ? parseInt(x) : -1 !== x.indexOf("vw") ? l * parseInt(x) / 100 : -1 !== x.indexOf("vh") ? o * parseInt(x) / 100 : -1 !== x.indexOf("%") ? l * parseInt(x) / 100 : parseInt(i.clientWidth)) / (parseInt(m[0]) / parseInt(m[1]));
...
},{}]},["fu47D","3auaO"], "3auaO", "parcelRequireef34")
