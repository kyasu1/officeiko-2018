...
var justinmimbs$date$Date$fromYearAndDay = function (_n0) {
	var y = _n0.a;
	var doy = _n0.b;
	switch (doy.$) {
		case 'MonthAndDay':
...
var justinmimbs$date$Date$int4 = A2(
	...
	A2(
		...
		A2(
			...
			elm$parser$Parser$chompIf(elm$core$Char$isDigit)),
		elm$parser$Parser$chompIf(elm$core$Char$isDigit)));
var justinmimbs$date$Date$yearAndDay = A2(
	elm$parser$Parser$keeper,
	A2(
		elm$parser$Parser$keeper,
		elm$parser$Parser$succeed(elm$core$Tuple$pair),
		justinmimbs$date$Date$int4),
	A2(elm$parser$Parser$ignorer, justinmimbs$date$Date$dayOfYear, elm$parser$Parser$end));
var justinmimbs$date$Date$fromIsoString = A2(
	elm$core$Basics$composeR,
	elm$parser$Parser$run(justinmimbs$date$Date$yearAndDay),
	A2(
		elm$core$Basics$composeR,
...
var author$project$HolidayParser$stringToDate = function (string) {
...
var author$project$HolidayParser$dateParser = A2(
	elm$parser$Parser$andThen,
	author$project$HolidayParser$stringToDate,
...
var author$project$HolidayParser$event = elm$parser$Parser$getChompedString(
	A2(
		elm$parser$Parser$ignorer,
		elm$parser$Parser$succeed(_Utils_Tuple0),
...
var author$project$HolidayParser$holiday = A2(
	elm$parser$Parser$keeper,
	A2(
		elm$parser$Parser$keeper,
		A2(
		...
		A2(elm$parser$Parser$ignorer, author$project$HolidayParser$dateParser, elm$parser$Parser$spaces)),
	A2(
		elm$parser$Parser$ignorer,
		author$project$HolidayParser$event,
		elm$parser$Parser$symbol(']')));
...
var author$project$HolidayParser$listHelp = function (revHoliday) {
				...
				elm$parser$Parser$succeed(
					function (h) {
						return elm$parser$Parser$Loop(
							A2(elm$core$List$cons, h, revHoliday));
					}),
				A2(elm$parser$Parser$ignorer, author$project$HolidayParser$holiday, elm$parser$Parser$spaces)),
				A2(
				elm$parser$Parser$map,
				function (_n0) {
					return elm$parser$Parser$Done(
						elm$core$List$reverse(revHoliday));
				},
				elm$parser$Parser$succeed(_Utils_Tuple0))
			]));
};
...
var author$project$HolidayParser$parser = function (string) {
	return A2(
		elm$parser$Parser$run,
		author$project$HolidayParser$list,
		A2(
...
var author$project$Main$listOfHolidayParser = function (string) {
...
var author$project$Main$init = function (flags) {
	...
	if (_n0.$ === 'Ok') {
		...
		return _Utils_Tuple2(
			{holiday: holiday, today: author$project$Main$Loading},
			A2(elm$core$Task$perform, author$project$Main$GetToday, author$project$Main$whatDayToday));
	} else {
		return _Utils_Tuple2(
			{holiday: _List_Nil, today: author$project$Main$Error},
		...
		if (A2(author$project$Calendar$inMonth, state, date)) {
			var temporary = A2(
				...
				A2(
					...
					special)) ? _List_fromArray(
				[
					elm$html$Html$Attributes$class('bg-orange')
				]) : _List_Nil;
			var closed = _List_fromArray(
				[
					elm$html$Html$Attributes$class('bg-green text-white')
				]);
				...
				if (_Utils_eq(
					...
					if (_Utils_eq(
						...
						if (_Utils_eq(
							...
							return _List_fromArray(
								[
									elm$html$Html$Attributes$class('text-red-dark')
								]);
						} else {
							if (_Utils_eq(
								justinmimbs$date$Date$weekday(date),
								...
								return _List_fromArray(
									[
										elm$html$Html$Attributes$class('text-blue-dark')
									]);
							} else {
								...
								if (_n1.$ === 'Just') {
									...
									return _List_fromArray(
										[
											elm$html$Html$Attributes$class('text-red-dark'),
											elm$html$Html$Attributes$title(event)
										]);
								} else {
									return _List_fromArray(
										[
...
var author$project$Main$calendarConfig = F3(
	function (calendar, holiday, today) {
		return author$project$Calendar$configWithCusgtomizations(
			{
				cellAttrs: A2(
					author$project$Main$cellAttrs,
					{national: holiday, special: _List_Nil, today: today},
					calendar),
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									A3(author$project$Main$calendarConfig, calendar, model.holiday, today),
									calendar)
								]));
					},
					A2(
